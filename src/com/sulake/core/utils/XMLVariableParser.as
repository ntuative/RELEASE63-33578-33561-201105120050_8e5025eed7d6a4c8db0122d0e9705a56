package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_283:String = "uint";
      
      public static const const_119:String = "Number";
      
      public static const const_1858:String = "float";
      
      public static const const_39:String = "Boolean";
      
      public static const const_1705:String = "bool";
      ...
      private static const const_648:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_649:String = "value";
      
      private static const const_662:String = "RoomWidgetInfostandExtraParamEnum";
      
      private static const const_1904:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_648);
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_648));
         }
         else
         {
            _loc4_ = param1.child(const_648)[0];
         }
         ...
         _loc7_ = param1.attribute(const_649);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_649));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_649)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_237 || _loc5_ == const_155)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_134:
               return uint(param1);
            case const_155:
               return param1.split(const_1431);
            default:
