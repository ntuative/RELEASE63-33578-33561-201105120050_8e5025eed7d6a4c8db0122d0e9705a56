package com.sulake.habbo.room
{
   ...
   public class RoomObjectFactory extends Component implements IRoomObjectFactory
   {
      ...
      {
         var _loc2_:* = null;
         if(this.var_1004.indexOf(param1) < 0)
         {
            this.var_1004.push(param1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1236.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         var _loc3_:int = this.var_1004.indexOf(param1);
         if(_loc3_ >= 0)
         {
            this.var_1004.splice(_loc3_,1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1236.getKeys())
               {
      ...
      {
         var _loc2_:* = null;
         if(this.var_1236.getValue(param1) == null)
         {
            this.var_1236.add(param1,true);
            for each(_loc2_ in this.var_1004)
            {
               if(_loc2_ != null)
               {
      ...
      public function createRoomObjectLogic(param1:String) : IRoomObjectEventHandler
      {
         ...
         if(_loc3_ is IRoomObjectEventHandler)
         {
            ...
            if(this.var_1950.getValue(param1) == null)
            {
               this.var_1950.add(param1,true);
