package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_894:String = "RCL_LOADER_READY";
      
      private static const const_362:String = "RCL_PUBLICROOM_";
      
      private static const const_1896:int = 0;
      
      private static const const_999:int = 1;
      
      private static const name_4:int = 2;
      
      private static const const_445:String = "place_holder";
      
      private static const const_640:String = "wall_place_holder";
      
      private static const const_641:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_445;
      
      private static const const_642:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_998:String = "selection_arrow";
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2359 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_999)
         {
            return;
         }
         this.var_1399 = param1;
         this.var_2358 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2355 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initPetData() : void
      {
         ...
         for each(_loc3_ in _loc1_)
         {
            ...
            this.var_909.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_733.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_419.add(_loc3_,_loc4_);
      ...
      private function continueInitilization() : void
      {
         if(this.var_2356)
         {
            ...
            {
               this.var_1399.dispatchEvent(new Event(const_894));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_497 != null)
         {
            this.var_497.remove(param1);
            this.var_497.add(param1,param2);
         }
         if(this.var_499 != null)
         {
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_497 != null)
         {
            _loc2_ = this.var_497.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         return [const_445,const_640,const_641,const_642,TILE_CURSOR,const_998];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_419.getValue(param1) as String;
      ...
      {
         return this.var_909.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_910[param1];
         if(_loc3_ != null)
         {
      ...
      {
         if(this.var_203 != null && this.var_203.hasWorldType(const_362 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_273 || param1 == RoomObjectVisualizationEnum.const_57 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_384,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1400.getValue(param1) != null)
         {
            this.var_203 = this.var_1400.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_929,this.onContentLoaded);
            _loc6_ = 0;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1687);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2359.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_384,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_465,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_910.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1400.add(param1,_loc4_);
         this.var_203 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_732.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_732.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_732.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_495.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(this.getObjectCategory(const_362 + param1) == RoomObjectCategoryEnum.const_81)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_203.getWorldHeightScale(const_362 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_203 != null)
         {
            return this.var_203.getWorldScale(const_362 + param1);
         }
         return 32;
      }
      ...
      public function setActiveObjectType(param1:int, param2:String) : void
      {
         ...
         this.var_419.add(param1,param2);
      }
   }
}
