package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1573:uint = 16777215;
      
      private var var_2035:int = 255;
      
      private var var_1283:uint = 16777215;
      
      private var var_2034:int = 255;
      
      private var var_1282:int = 0;
      
      private var var_2033:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_582,RoomObjectMouseEvent.const_143];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1150,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_717,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_926,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_692,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1282)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1844;
            if(_loc2_ - this.var_1282 >= this.var_2033)
            {
               _loc3_ = this.var_1283;
               _loc4_ = this.var_2034;
               this.var_1282 = 0;
            }
            else
            {
               _loc7_ = this.var_1573 >> 16 & 255;
               _loc8_ = this.var_1573 >> 8 & 255;
               _loc9_ = this.var_1573 & 255;
               _loc10_ = this.var_1283 >> 16 & 255;
               _loc11_ = this.var_1283 >> 8 & 255;
               _loc12_ = this.var_1283 & 255;
               _loc13_ = (_loc2_ - this.var_1282) / this.var_2033;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2035 + (this.var_2034 - this.var_2035) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_717,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_865:
               param2.setString(RoomObjectVariableEnum.const_205,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_887:
               param2.setString(RoomObjectVariableEnum.const_190,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_837:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_514:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_275)
               {
                  _loc5_ = "null";
               }
               this.var_544.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_773:
               _loc4_ = this.var_544.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_544.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1176,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1197:
               param2.setNumber(RoomObjectVariableEnum.const_926,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1277:
               param2.setNumber(RoomObjectVariableEnum.const_692,_loc3_);
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1017:
               param2.setNumber(RoomObjectVariableEnum.const_1120,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1315:
               param2.setNumber(RoomObjectVariableEnum.const_1118,param1.value);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1111,int(param1.bgOnly));
         this.var_1573 = this._color;
         this.var_2035 = this.var_1844;
         this.var_1283 = _loc3_;
         this.var_2034 = _loc4_;
         this.var_1282 = getTimer();
         this.var_2033 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1784,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1685,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1761,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_243 || _loc12_ == RoomPlaneData.const_417)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
