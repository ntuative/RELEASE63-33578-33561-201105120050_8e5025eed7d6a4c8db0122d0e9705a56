package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1897:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1467:IAvatarImage;
      ...
      private var var_2388:ByteArray;
      
      private var var_2387:ImageData;
      
      private var var_906:PaletteMap;
      ...
      {
         if(this.var_736 == param1)
         {
            return;
         }
         if(this.var_736 == GeometryType.const_1320 && param1 == GeometryType.const_1133 || this.var_736 == GeometryType.const_1133 && param1 == GeometryType.const_1320)
         {
            this.var_736 = param1;
            this.var_87 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_346.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_760)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_568)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1467.getFigure(),_loc5_,this.var_736,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_451 == null)
         {
            ...
            this.var_451 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_346);
            if(this.var_451 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_87)
         {
            this.var_87 = this._structure.getCanvas(this._scale,this.var_736);
            if(!this.var_87)
            {
               return null;
            }
            this.var_2386 = new Point(0,this.var_87.height - int(this.var_87.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1848[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_930 || _loc10_ == AvatarAction.const_385;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1408 = this.var_113.bodyPartId;
               this.var_178 = this.var_113.partType;
               this.var_1759 = this.var_113.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_113.flippedPartType != this.var_178)
                     {
                        this.var_178 = this.var_113.flippedPartType;
                     }
                  }
               }
               this.var_1407 = this._scale + "_" + this.var_113.action.assetPartDefinition + "_" + this.var_178 + "_" + this.var_1759 + "_" + _loc5_ + "_" + this._frame;
               this.var_421 = this._assets.getAssetByName(this.var_1407) as BitmapDataAsset;
               if(this.var_421 == null)
               {
                  this.var_1407 = this._scale + "_std_" + this.var_178 + "_" + this.var_1759 + "_" + _loc5_ + "_0";
                  this.var_421 = this._assets.getAssetByName(this.var_1407) as BitmapDataAsset;
               }
               if(!(!this.var_421 || !this.var_421.content))
               {
                  ...
                  {
                     this.var_906 = this._structure.renderManager.paletteManager.getPalette(this.var_113.paletteMapId);
                     if(this.var_906 != null)
                     {
                        this.var_913 = this.var_421.content as BitmapData;
                        this.var_179 = new BitmapData(this.var_913.width,this.var_913.height);
                        this.var_2388 = this.var_906.colorize(this.var_913.getPixels(this.var_913.rect));
                        this.var_179.setPixels(this.var_179.rect,this.var_2388);
                     }
                     else
                     {
                  ...
                  if(_loc11_ && (this.var_1408 == AvatarBodyPartType.const_263 || this.var_1408 == AvatarBodyPartType.const_1801 || this.var_1408 == AvatarBodyPartType.const_1855) && this.var_113.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_179.colorTransform(this.var_179.rect,this.var_113.color.colorTransform);
                  }
                  if(this.var_113.isBlendable)
                  {
                     this.var_179.colorTransform(this.var_179.rect,this.var_113.blendTransform);
                  }
                  this.var_914 = this.var_421.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_55)
                     {
                  ...
                  this.var_2387 = new ImageData(this.var_179,this.var_914,_loc7_);
                  this.var_915.push(this.var_2387);
               }
            }
            _loc8_--;
         }
         if(this.var_915.length == 0)
         {
            return null;
         }
         var _loc13_:ImageData = this.createUnionImage(this.var_915,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2386.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_55)
            {
         ...
         _loc8_ = this.var_915.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_915.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
