package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_712:Number = 64;
      
      public static const const_1304:Number = 32;
      ...
      private var var_1875:Number = 1.0;
      
      private var var_1876:Number = 1.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1876 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_446.assign(this.var_93);
         this.var_446.x *= this.var_443;
         this.var_446.y *= this.var_445;
         this.var_446.z *= this.var_444;
         return this.var_446;
      }
      ...
      {
         if(this.var_443 != param1 * this.var_1874)
         {
            this.var_443 = param1 * this.var_1874;
            ++this.var_165;
         }
      }
      ...
      {
         if(this.var_445 != param1 * this.var_1875)
         {
            this.var_445 = param1 * this.var_1875;
            ++this.var_165;
         }
      }
      ...
      {
         if(this.var_444 != param1 * this.var_1876)
         {
            this.var_444 = param1 * this.var_1876;
            ++this.var_165;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_93.x /= this.var_443;
         this.var_93.y /= this.var_445;
         this.var_93.z /= this.var_444;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_447.x;
         var _loc3_:Number = this.var_447.y;
         var _loc4_:Number = this.var_447.z;
         this.var_447.assign(param1);
         this._direction.assign(param1);
         if(this.var_447.x != _loc2_ || this.var_447.y != _loc3_ || this.var_447.z != _loc4_)
         {
            ++this.var_165;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1196.assign(this.var_158);
         }
         else
         {
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_528 != null)
         {
            ...
            this.var_528.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_528.add(_loc3_,_loc4_);
            ++this.var_165;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_528 != null)
         {
            ...
            return this.var_528.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_443;
         _loc2_.y *= this.var_445;
         _loc2_.z *= this.var_444;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1195);
         if(_loc3_ < this.var_2953 || _loc3_ > this.var_2954)
         {
            return null;
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_93.x * this.var_443,this.var_93.y * this.var_445,this.var_93.z * this.var_444);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_158;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_443,param2.y * this.var_445,param2.z * this.var_444);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_443,param3.y * this.var_445,param3.z * this.var_444);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_443,param4.y * this.var_445,param4.z * this.var_444);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1304;
         }
         else
         {
            this.scale = const_712;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_712;
      }
