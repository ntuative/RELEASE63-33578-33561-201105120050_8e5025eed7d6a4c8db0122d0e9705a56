package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1885:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2573:Number = NaN;
      
      private var var_2575:int = -1;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1193:String = null;
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2574;
            }
            else
            {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_398:
               break;
            case LayerData.const_1119:
               _loc2_ = "null";
               break;
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_475 != _loc3_.getUpdateID() || param1 != var_89 || param2 != this.var_2573)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2575 = _loc3_.getNumber(RoomObjectVariableEnum.const_256);
            ...
            this.var_1193 = this.getAdClickUrl(_loc3_);
            if(this.var_1193 == null || this.var_1193.indexOf("http") != 0)
            {
               this.var_1193 = null;
            }
            this.var_2574 = this.var_1193 != null;
            this.var_2572 = _loc3_.getNumber(RoomObjectVariableEnum.const_935);
      ...
      {
         if(this.var_2578 != param2 || this.var_2577 != param1)
         {
            this.var_970 = [];
            this.var_971 = [];
            this.var_780 = [];
            ...
            this.var_2576 = this.getSize(param1);
      ...
      {
         this.var_663 = param1;
         this.var_1478 = this.var_663 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_543.length)
         {
            return "";
         }
         var _loc3_:String = this.var_970[param2];
         var _loc4_:Boolean = this.var_971[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2576;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1478)
            {
               _loc6_ = FurnitureVisualizationData.const_543[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_970[param2] = _loc3_;
            this.var_971[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_778[param3] != null && !this.var_1871)
         {
            return this.var_778[param3];
         }
         if(this._data == null)
         {
         ...
         this.var_778[param3] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteColor(param1:int, param2:int, param3:int) : int
      {
         if(this.var_784[param2] != null)
         {
            return this.var_784[param2];
         }
         if(this._data == null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2572 * (param1 / 2));
      }
      
      protected function getSpriteMouseCapture(param1:int, param2:int, param3:int) : Boolean
      {
         if(this.var_779[param3] != null)
         {
            return this.var_779[param3];
         }
         if(this._data == null)
         {
            return true;
