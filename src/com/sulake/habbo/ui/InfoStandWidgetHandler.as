package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_221:IHabboMusicController;
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_221.events.addEventListener(NowPlayingEvent.const_101,this.onNowPlayingChanged);
            this.var_221.events.addEventListener(SongInfoReceivedEvent.const_91,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_111,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_178,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_111,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_178,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_613.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_613.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_221 != null)
         {
            this.var_221.events.removeEventListener(NowPlayingEvent.const_101,this.onNowPlayingChanged);
            this.var_221.events.removeEventListener(SongInfoReceivedEvent.const_91,this.onSongInfoReceivedEvent);
            this.var_221 = null;
         }
         this.var_1077 = true;
         this.container = null;
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomObjectMessage.const_873);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_893);
         _loc1_.push(RoomWidgetFurniActionMessage.const_281);
         _loc1_.push(RoomWidgetFurniActionMessage.const_958);
         _loc1_.push(RoomWidgetFurniActionMessage.const_713);
         _loc1_.push(RoomWidgetFurniActionMessage.const_747);
         _loc1_.push(RoomWidgetFurniActionMessage.const_925);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_729);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_721);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_686);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1800);
         _loc1_.push(RoomWidgetPetCommandMessage.const_610);
         _loc1_.push(RoomWidgetPetCommandMessage.const_890);
         _loc1_.push(RoomWidgetUserActionMessage.const_529);
         _loc1_.push(RoomWidgetUserActionMessage.const_388);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_867);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_388 || param1.type == RoomWidgetUserActionMessage.const_529 || param1.type == RoomWidgetUserActionMessage.const_623)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectMessage.const_873:
            ...
            case RoomWidgetUserActionMessage.const_549:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1160,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_540:
               ...
               break;
            case RoomWidgetUserActionMessage.const_893:
            ...
            case RoomWidgetUserActionMessage.const_623:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_958:
            ...
            case RoomWidgetUserActionMessage.const_388:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_729:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_721:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_686:
            ...
            case RoomWidgetUserActionMessage.const_551:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_890:
            ...
            case RoomWidgetPetCommandMessage.const_610:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_867:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_279);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_327);
               _loc6_.id = param1.id;
               _loc6_.category = param1.category;
               _loc7_ = this._container.roomEngine.getRoomObject(_loc2_,_loc3_,param1.id,param1.category);
               _loc8_ = _loc7_.getModel();
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_250) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_250);
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_279);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1255);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1232);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_550)
                  {
                     _loc30_ = this.var_221.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_391) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_391.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_221.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_164)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_587)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_487);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_145)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_704);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_808;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_696;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1874);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_613.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_613.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_704);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_221 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_221.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_373,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_221 != null)
         {
            _loc2_ = this.var_221.getSongInfo(param1.id);
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_428,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
