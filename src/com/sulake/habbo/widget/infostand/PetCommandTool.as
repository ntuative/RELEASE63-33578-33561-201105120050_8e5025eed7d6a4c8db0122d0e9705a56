package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private static const const_1357:Point = new Point(100,30);
      ...
      private var var_412:IFrameWindow;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_340 = new Timer(this.const_2172);
         this.var_340.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1108.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_490);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1108.getValue(this.var_490) as CommandConfiguration;
      ...
      {
         this.var_1108.remove(param1);
         this.var_1108.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_890,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_40.context.getDesktopWindow().addEventListener(WindowEvent.const_43,this.onWindowDesktopResized);
         this.var_40.procedure = this.onCommandWindowProcedure;
         this.var_40.position = const_1357;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_412 == null)
         {
            ...
            this.var_412 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_412 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_412.x = 200;
            this.var_412.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_388,this.var_490));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_610,this.var_490,this.var_1677 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_610,this.var_490,this.var_1677 + " " + _loc5_);
