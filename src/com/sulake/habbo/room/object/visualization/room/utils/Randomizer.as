package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2087:int = 16777216;
      ...
      private var var_2012:int = 16777216;
      
      private var var_2959:int = 69069;
      
      private var var_2960:int = 5;
      ...
      {
         var _loc1_:int = this.var_2959 * this.var_2011 + this.var_2960;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2012;
         this.var_2011 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_2012 * param2);
      }
   }
}
