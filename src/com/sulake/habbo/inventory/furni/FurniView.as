package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_999:int = 1;
      
      private const const_1930:int = 2;
      
      private const const_1929:int = 3;
      
      private const const_1932:int = 42;
      
      private const const_1931:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_460.add(FurniModel.const_40,new FurniGridView(this.var_66,FurniModel.const_40,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_460.add(FurniModel.const_48,new FurniGridView(this.var_66,FurniModel.const_48,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_460.getValue(this.var_459);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_66.getCategoryContent(this.var_459);
         if(!this.var_66.isListInited())
         {
            _loc2_ = this.const_999;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1930;
         }
         else
         {
            _loc2_ = this.const_1929;
         }
         if(this.var_2274 == _loc2_)
         {
            return;
         }
         this.var_2274 = _loc2_;
         ...
         switch(_loc2_)
         {
            case this.const_999:
               ...
               break;
            case this.const_1930:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1929:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_40,FurniModel.const_48];
         var _loc4_:int = 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_66.getGroupItemInIndex(_loc3_,this.var_459);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_190);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_205);
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_195);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_717 && this.var_717.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1931)
         {
            _loc3_ = this.const_1931;
         }
         else if(_loc3_ < this.const_1932)
         {
            _loc3_ = this.const_1932;
         }
         else
         {
