package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_1097:IRoomSession;
      ...
      private var var_2633:GiftWrappingConfiguration;
      
      private var var_1214:ClubGiftController;
      
      private var var_535:ClubBuyController;
      
      private var var_798:Map;
      
      private var var_1213:Boolean = false;
      
      private var var_989:IPurchasableOffer;
      
      private var var_1503:IDragAndDropDoneReceiver;
      
      private var var_64:PlacedObjectPurchaseData;
      
      private const const_1005:Point = new Point(100,20);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1802);
               return;
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            ...
            this.var_228.showOffer(this,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_535.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_376.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_175.getKey("client.credits.embed.enabled","false") == "RoomWidgetInfostandExtraParamEnum";
         if(false && _loc1_)
         {
      ...
      {
         var _loc2_:Array = this.var_798.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_105.getActivityPointsForType(Purse.const_219)));
         var _loc1_:int = 0;
      ...
      {
         if(param1.iconId == HabboToolbarIconEnum.CATALOGUE && param1.type == HabboToolbarEvent.const_37)
         {
            this.toggleCatalog();
         }
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_376 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer.position = this.const_1005;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_257,false);
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1214 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_535 == null)
         {
            this.var_535 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_376.buildCatalogIndex(_loc2_);
         if(this.var_797 && this.var_797 != "")
         {
            this.var_376.openPage(this.var_797);
            this.var_797 = "";
            this.var_990 = -1;
         }
         else if(this.var_990 > -1)
         {
            this.var_376.openPageById(this.var_990,this.var_1925);
            this.var_990 = -1;
            this.var_1925 = -1;
            this.var_797 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2635 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1322);
         }
         this.var_2635 = false;
         if(this._chargeConfirmationDialog != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_69,this.var_105.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1113);
         }
         this.var_2634 = false;
         if(this._chargeConfirmationDialog != null)
         {
         ...
         if(_loc2_.type == Purse.const_219)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1214.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2633 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_798.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_798.add(_loc2_.productCode,_loc3_.slice());
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "RoomWidgetInfostandExtraParamEnum" == this.var_175.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
      ...
      {
         if(!this.var_175.keyExists("catalog.drag_and_drop") || this.var_175.getKey("catalog.drag_and_drop") != "RoomWidgetInfostandExtraParamEnum")
         {
            return false;
         }
         if(!this.var_1097 || !this.var_1097.isRoomOwner)
         {
            return false;
         }
         ...
         switch(_loc2_.productType)
         {
            case ProductTypeEnum.const_206:
               _loc3_ = false;
               break;
            case ProductTypeEnum.const_305:
               _loc3_ = false;
         }
         return _loc3_;
      }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_190);
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_205);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_195);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1213 && param1.type == RoomEngineObjectEvent.const_139)
         {
            ...
            _loc3_ = this.var_989.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_64 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_989);
            _loc5_ = this.var_1503;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_311,0.5);
            }
         }
      }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc2_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_190);
         ...
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_195);
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_175.getKey("image.library.catalogue.url");
