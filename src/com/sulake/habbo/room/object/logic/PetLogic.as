package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_143,RoomObjectMoveEvent.const_408];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2587)
         {
            ...
            if(param1 is RoomObjectAvatarUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_199,_loc4_.dirHead);
               return;
            }
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1484 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
            {
               _loc6_ = param1 as RoomObjectAvatarPetGestureUpdateMessage;
               _loc2_.setString(RoomObjectVariableEnum.const_135,_loc6_.gesture);
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_369,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_934,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            _loc10_ = param1 as RoomObjectAvatarFigureUpdateMessage;
            _loc11_ = _loc2_.getString(RoomObjectVariableEnum.const_189);
            _loc2_.setString(RoomObjectVariableEnum.const_189,_loc10_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1815,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_913,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_199,_loc3_ + this.var_979);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1884;
            _loc2_.setNumber(RoomObjectVariableEnum.const_277,this.var_1884);
            _loc2_.setNumber(RoomObjectVariableEnum.const_135,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1885;
            _loc2_.setNumber(RoomObjectVariableEnum.const_135,this.var_1885);
         }
         else
         {
            this.var_979 += 45;
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         ...
         {
            param2.setString(RoomObjectVariableEnum.const_135,null);
            this.var_1483 = 0;
         }
         if(this.var_1484 > 0)
         {
