package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_644:String = "room";
      
      private static const const_1003:int = -2;
      
      private static const const_1398:String = "tile_cursor";
      
      private static const const_1004:int = -3;
      
      private static const const_1397:String = "selection_arrow";
      
      private static const OVERLAY_SPRITE:String = "overlay";
      
      private static const const_363:String = "object_icon_sprite";
      
      private static const const_447:int = 15;
      
      private static const const_1002:int = 40;
      ...
      private var var_739:IRoomObjectFactory = null;
      
      private var var_495:IRoomObjectVisualizationFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_738 = new NumberBank(1000);
         this.var_1138 = new Map();
         this.var_349 = new Map();
         this.var_62 = new RoomObjectEventHandler(this);
         this.var_921 = new RoomMessageHandler(this);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_739.release(new IIDRoomObjectFactory());
            this.var_739 = null;
         }
         if(this.var_495 != null)
         {
            this.var_495.release(new IIDRoomObjectVisualizationFactory());
            this.var_495 = null;
         }
         ...
         {
            this._toolbar.events.removeEventListener(HabboToolbarEvent.const_37,this.onToolbarClicked);
         ...
         if(this.var_301 != null)
         {
            ...
            {
               _loc2_ = this.var_301.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_301.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            this.var_301.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      {
         return this.getRoomCamera(this.var_72,this.var_73);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            _loc2_ = this._roomManager.getRoom(this.getRoomIdentifier(this.var_72,this.var_73));
      ...
      {
         this.var_1139 = false;
         if(this.var_506 && this.var_506.length > 0)
         {
      ...
      public function requestMouseCursor(param1:String, param2:int, param3:String) : void
      {
         ...
         switch(param1)
         {
            case RoomObjectFurnitureActionEvent.const_292:
      ...
      private function addBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc3_:IRoomSession = this.var_15.getSession(this.var_72,this.var_73);
         ...
         var _loc5_:int = this.var_506.indexOf(_loc4_);
         if(_loc5_ == -1)
         {
            this.var_506.push(_loc4_);
            this.var_1139 = true;
         }
      }
      ...
      private function removeBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc4_:int = this.var_506.indexOf(_loc3_);
         if(_loc4_ > -1)
         {
            this.var_506.splice(_loc4_,1);
            this.var_1139 = true;
         }
      }
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_920 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_301.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  if(_loc5_ != this.var_72 || _loc6_ != this.var_73 || !this.var_919)
                  {
               ...
               if(_loc11_ != null)
               {
                  if(this.var_919)
                  {
                     _loc11_.screenOffsetX += this.var_1414;
                     _loc11_.screenOffsetY += this.var_1412;
                     this.var_1414 = 0;
                     this.var_1412 = 0;
                  }
               }
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc13_ || _loc9_.screenHt != _loc14_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc) || _loc9_.isMoving)
               {
                  ...
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_706) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_809) - 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_782) + 0.5;
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_739 = param2 as IRoomObjectFactory;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_495 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_13 != null)
         {
            this.var_13.visualizationFactory = this.var_495;
         }
         this.initializeRoomManager();
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_921 != null)
            {
               this.var_921.connection = param1;
            }
         }
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_894,this.onContentLoaderReady);
            this.var_13.initialize(events,this.var_145);
         }
         this.var_2400 = this.var_145.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      
      private function onContentLoaderReady(param1:Event) : void
      {
         if(param1 != null && param1.type == RoomContentLoader.const_894)
         {
            this.var_2402 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_308.events.addEventListener(AdEvent.const_469,this.showRoomAd);
         this.var_308.events.addEventListener(AdEvent.const_822,this.onRoomAdImageLoaded);
         this.var_308.events.addEventListener(AdEvent.const_768,this.onRoomAdImageLoaded);
      }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_37,this.onToolbarClicked);
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_739 != null)
         {
            this.var_739.addObjectEventListener(this.roomObjectEventHandler);
         }
      }
      
      private function initializeRoomManager() : void
      {
         if(this.var_739 == null || this.var_495 == null || this._roomManager == null || this._roomRendererFactory == null || this._communication == null || this.var_145 == null || !this.var_2402)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_507 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_815,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_349.length)
            {
               _loc3_ = this.var_349.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1327,_loc5_);
            if(_loc5_ == 0)
            {
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1327);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_507)
         {
            _loc5_ = this.var_349.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_349.add(_loc4_,_loc5_);
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.method_2(const_364,_loc11_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1148,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_800,1,true);
            _loc12_ = parseInt(this.var_145.getKey("ads.billboard.displayDelayMillis","1000"));
         ...
         {
            _loc9_ = _loc7_.method_2(const_364,const_644,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_800,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_962,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_706,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_782,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_809,_loc17_);
         ...
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_865,param3);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_205,param3);
            }
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_887,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_190,param4);
            }
            if(param5 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_837,param5);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_195,param5);
            }
            if(param2 != null)
            {
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_514,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_275);
                        _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_888,_loc25_ - 0.5,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_941,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_888,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_941,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1272,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1089,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.method_2(const_1003,const_1398,RoomObjectCategoryEnum.const_347);
         if(this.var_145.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.method_2(const_1004,const_1397,RoomObjectCategoryEnum.const_347);
         }
         return _loc7_;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null, param6:Boolean = false) : Boolean
      {
         ...
         if(_loc7_ == null)
         {
            ...
            _loc11_ = this.var_349.getValue(_loc10_);
            if(_loc11_ == null)
            {
               _loc11_ = new RoomData(param1,param2,null);
               this.var_349.add(_loc10_,_loc11_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            ...
            {
               _loc8_.setString(RoomObjectVariableEnum.const_205,param3);
            }
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_865,param3);
         ...
         if(param4 != null)
         {
            if(_loc8_ != null && !param6)
            {
               _loc8_.setString(RoomObjectVariableEnum.const_190,param4);
            }
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_887,param4);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         if(param5 != null)
         {
            if(_loc8_ != null && !param6)
            {
               _loc8_.setString(RoomObjectVariableEnum.const_195,param5);
            }
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_837,param5);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1635,param3,param4,param5);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1277,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1197,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function updateObjectRoomPlaneThicknesses(param1:int, param2:int, param3:Number, param4:Number) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_1315,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_1017,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_301.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1276;
         ...
         _loc10_.mouseListener = this.var_62;
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_962);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_888);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_941);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1272);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1089);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         var _loc9_:int = param3 - this.var_1415;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_919 = true;
               this.var_740 = false;
               this.var_2401 = this.var_1413;
               this.var_2399 = this.var_1415;
            }
         }
         else if(param4 == MouseEvent.MOUSE_UP)
         {
            if(this.var_919)
            {
               ...
               if(this.var_740)
               {
                  _loc10_ = this.getRoomInstanceData(this.var_72,this.var_73);
                  if(_loc10_ != null)
                  {
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_919)
            {
               if(!this.var_740)
               {
                  _loc8_ = param2 - this.var_2401;
                  _loc9_ = param3 - this.var_2399;
                  if(_loc8_ <= -const_447 || _loc8_ >= const_447 || _loc9_ <= -const_447 || _loc9_ >= const_447)
                  {
                     this.var_740 = true;
                  }
                  _loc8_ = 0;
               ...
               {
                  this.var_1414 += _loc8_;
                  this.var_1412 += _loc9_;
                  this.var_740 = true;
               }
            }
         }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_72,this.var_73,param1);
         if(_loc9_ != null)
         {
            _loc10_ = this.getOverlaySprite(_loc9_);
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_363);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_632,this.var_72,this.var_73,-1,RoomObjectCategoryEnum.const_182));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_62 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_364,const_644);
                     this.var_62.handleRoomObjectEvent(_loc14_,this.var_72,this.var_73);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc5_ = this.getRoomObjectImage(this.var_72,this.var_73,param1,param2,new Vector3d(),1,null);
         }
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_72,this.var_73,this.var_1411);
         if(_loc6_ != null)
         {
            _loc9_ = this.getOverlaySprite(_loc6_);
            this.removeOverlayIconSprite(_loc9_,const_363);
            _loc10_ = this.addOverlayIconSprite(_loc9_,const_363,_loc5_.data);
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1413 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1415 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_72,this.var_73,this.var_1411);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_363);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_72,this.var_73,this.var_1411);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_363);
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_62 != null)
         {
            return this.var_62.modifyRoomObject(this.var_72,this.var_73,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectDataWithMap(param1:int, param2:int, param3:String, param4:Map) : Boolean
      {
         if(this.var_62 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_62.modifyRoomObjectData(this.var_72,this.var_73,param1,param2,param3,param4);
            }
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_62 != null)
         {
            ...
            {
               return this.var_62.modifyWallItemData(this.var_72,this.var_73,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_62 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_62.deleteWallItem(this.var_72,this.var_73,param1);
            }
         }
         return false;
      }
      ...
      {
         var _loc5_:IRoomInstance = this.getRoom(this.var_72,this.var_73);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_800) != 0)
         {
            return false;
         }
         if(this.var_62 != null)
         {
            return this.var_62.initializeRoomObjectInsert(this.var_72,this.var_73,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_62 != null)
         {
            this.var_62.cancelRoomObjectInsert(this.var_72,this.var_73);
         }
      }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:IRoomObject = this.getRoomObject(this.var_72,this.var_73,param1,param2);
         if(_loc3_ != null)
         {
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1004,RoomObjectCategoryEnum.const_347);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1003,RoomObjectCategoryEnum.const_347);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_256,_loc7_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_279,param4.typeId,true);
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_376,_loc8_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_878,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1255,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1232,getTimer());
            if(param4.knownAsUsable)
            {
               _loc9_.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_250,RoomWidgetInfostandExtraParamEnum.const_688);
            }
         }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_256,_loc6_,false);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_279,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_376,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1276,1,true);
            if(param4.knownAsUsable)
            {
               _loc8_.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_250,RoomWidgetInfostandExtraParamEnum.const_688);
            }
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            if(_loc7_.getModel() != null)
            {
               ...
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1282);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_514,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_773,_loc5_);
                  }
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_199);
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_904,this.var_72,this.var_73,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_62 != null)
         {
            this.var_62.handleRoomObjectEvent(param1,this.var_72,this.var_73);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_256));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_322);
                     break;
                  case RoomObjectCategoryEnum.const_33:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_189);
               }
            }
         }
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               param1.getModelController().setString(RoomObjectVariableEnum.const_205,_loc4_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_190,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_195,_loc6_);
               if(_loc7_ != null)
               {
                  _loc13_ = null;
                  _loc14_ = "undefined_1";
                  _loc13_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_514,_loc14_,_loc7_,new Vector3d(2.5,0.5,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         var _loc12_:int = this.var_738.reserveNumber();
         ...
         _loc12_ += 1;
         var _loc14_:IRoomObjectController = _loc11_.method_2(_loc12_,param1,_loc13_) as IRoomObjectController;
         ...
         switch(_loc13_)
         {
            case RoomObjectCategoryEnum.const_27:
            case RoomObjectCategoryEnum.const_26:
               _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_256,int(param2));
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_322,param7);
               break;
            case RoomObjectCategoryEnum.const_33:
               if(param1 == "user" || param1 == "bot" || param1 == "pet")
               {
                  _loc14_.getModelController().setString(RoomObjectVariableEnum.const_189,param2);
               }
               else
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_913,int(param2));
               }
               break;
         ...
         if(param8 > -1)
         {
            _loc18_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_96);
         ...
         {
            this.var_1138.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1208,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_738.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_72,this.var_73,const_364,RoomObjectCategoryEnum.const_81,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1208);
               ...
               this.var_738.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1138.remove(String(_loc10_)) as IGetImageListener;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_96);
            if(_loc7_ != null)
            {
      ...
      public function selectAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         if(this.var_62 != null)
         {
            this.var_62.setSelectedAvatar(param1,param2,param3,param4);
         }
      }
      ...
      public function getSelectedAvatarId() : int
      {
         if(this.var_62 != null)
         {
            return this.var_62.getSelectedAvatarId();
         }
         return -1;
      }
      ...
      public function selectRoomObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         this.var_62.setSelectedObject(param1,param2,param3,param4);
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_412,param1.image,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1251,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1114,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1090,RoomObjectVariableEnum.const_412,param1.clickUrl);
      ...
      public function requestRoomAdImage(param1:int, param2:int, param3:String, param4:String) : void
      {
         ...
         {
            this.var_308.loadRoomAdImage(param1,param2,param3,param4);
         }
      }
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_822:
               ...
               break;
            case AdEvent.const_768:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1203,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
         }
         if(_loc4_ != null)
         {
            _loc3_.getEventHandler().processUpdateMessage(_loc4_);
