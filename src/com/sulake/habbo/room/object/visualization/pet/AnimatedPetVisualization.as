package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1408:String = "head";
      
      private static const const_645:int = 1;
      
      private static const const_1009:int = 1000;
      
      private static const const_1411:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1411) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_351 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2419)
            {
               this.var_2419 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_277);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_135);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_277);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_135);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_1794 = _loc3_.getNumber(RoomObjectVariableEnum.const_369) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_199);
            if(!isNaN(_loc8_))
            {
               this.var_1777 = _loc8_;
            }
            else
            {
               this.var_1777 = direction;
            }
            this.var_1361 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2183 = _loc3_.getNumber(RoomObjectVariableEnum.const_934);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_913);
            if(_loc9_ != this.var_1776)
            {
               this.var_1776 = _loc9_;
               this.var_2420 = this.var_1776.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_351 != null)
         {
            ...
            if(this.var_1361 > 0)
            {
               _loc2_ = param1 - this.var_1361;
               if(_loc2_ < const_1009)
               {
                  this.var_351.alpha = int(Math.sin(_loc2_ / const_1009 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_351.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_351.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_645;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2420);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_645)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_645))
            {
               if(param2 >= FurnitureVisualizationData.const_543.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_543[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1777);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_89,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1408)
            {
               this.var_925[param1] = true;
            }
            else
            {
               this.var_925[param1] = false;
            }
         }
