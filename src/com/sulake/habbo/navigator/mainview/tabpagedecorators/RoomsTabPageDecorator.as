package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function prepareRoomCategories() : void
      {
         ...
         this.var_151.procedure = null;
         this.var_151.populate(_loc1_);
         this.var_151.selection = 0;
         this.var_151.procedure = this.onChangeFilter;
      }
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_204,Tabs.const_413);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_204,Tabs.const_785);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_204,Tabs.const_413,"" + _loc3_);
         }
         if(this.var_151)
         {
