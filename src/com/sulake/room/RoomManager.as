package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_156:IRoomManagerListener;
      
      private var var_2978:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_591 = [];
         this.var_592 = [];
         events.addEventListener(RoomContentLoadedEvent.const_384,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_465,this.onContentLoaded);
      ...
      {
         var _loc1_:* = null;
         if(this.var_593 == null || this.var_495 == null)
         {
            return;
         }
         ...
         {
            _loc1_ = this.var_1122;
            this.var_1122 = null;
            this.initialize(_loc1_,this.var_156);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_591.indexOf(_loc5_) < 0)
            {
               this.var_53.loadObjectContent(_loc5_,events);
               this.var_591.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1240;
         return true;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_592.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
         this.var_592.push(param1);
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_592.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_592[_loc4_];
      ...
      public function method_2(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_495.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_495.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_53.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_591.indexOf(param1);
            if(_loc2_ >= 0)
            {
            ...
            {
               this._state = const_919;
               if(this.var_156 != null)
               {
                  this.var_156.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_868;
            this.var_156.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_156 != null)
            {
               this.var_156.contentLoaded(null,false);
            }
            return;
         }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_905.length > 0)
         {
            ...
            if(_loc3_ == null)
            {
               if(this.var_156 != null)
               {
                  this.var_156.contentLoaded(_loc2_,false);
               }
               return;
            }
            ...
            if(this.var_156 != null)
            {
               this.var_156.contentLoaded(_loc2_,true);
            }
            if(this.var_591.length > 0)
            {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_53 == null || this.var_495 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_495.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_495.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              if(this.var_156 != null)
                              {
                                 this.var_156.objectInitialized(_loc10_,_loc15_.getId(),_loc12_);
                              }
                           }
                        }
                        else
