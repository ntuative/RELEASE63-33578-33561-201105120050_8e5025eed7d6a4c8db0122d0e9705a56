package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1251:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_669 = new Timer(100);
         this.var_669.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_669)
         {
            this.var_669.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_669.reset();
            this.var_669 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1251.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1983 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1983 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_187 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this._list = IItemListWindow(this.var_187.findChildByName("item_list"));
         this.method_5();
         ...
         var _loc3_:IWindow = this.var_187.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1252 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_187.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_187.desktop,this.var_187.width,this.var_187.height);
         this.var_187.x = _loc4_.x;
         this.var_187.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1252.goBackToInitialState();
         this.var_1252.input.textBackgroundColor = 4294967295;
         this.var_1251 = this.var_45[0];
         this.method_5();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_79,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1252.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_187.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_187.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1252.getText();
         var _loc3_:String = "model_" + this.var_1251.name;
