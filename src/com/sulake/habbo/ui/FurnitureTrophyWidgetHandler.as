         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_902:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getNumber(RoomObjectVariableEnum.const_256);
                     _loc6_ = _loc4_.getString(RoomObjectVariableEnum.const_96);
                     ...
                     _loc10_ = new RoomWidgetTrophyDataUpdateEvent(RoomWidgetTrophyDataUpdateEvent.const_762,_loc5_,_loc7_,_loc8_,_loc9_);
