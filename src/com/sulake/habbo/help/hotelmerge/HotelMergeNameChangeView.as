package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_746)
         {
            this.var_746 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_746)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_745)
         {
            this.var_745 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_745)
            {
               return;
            }
