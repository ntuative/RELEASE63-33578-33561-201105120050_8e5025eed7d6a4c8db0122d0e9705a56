package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_666:String = "Navigation";
      
      private static const const_665:String = "Friend Bar";
      
      private static const const_1520:String = "go.friendbar";
      
      private static const const_1522:String = "chat_btn_click";
      
      private static const const_1523:String = "find_friends_btn_click";
      
      private static const const_1066:String = "Toolbar";
      
      private static const const_1064:String = "open";
      
      private static const const_1065:String = "close";
      
      private static const const_1521:String = "FRIENDLIST";
      
      private static const const_1524:String = "MESSENGER";
       
      
      private var var_88:IHabboCommunicationManager;
      
      private var var_321:IHabboFriendList;
      
      private var var_468:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_88)
            {
               this.var_88.release(new IIDHabboCommunicationManager());
               this.var_88 = null;
            }
            if(this.var_321)
            {
               this.var_321.release(new IIDHabboFriendList());
               this.var_321 = null;
            }
            if(this.var_468)
            {
               this.var_468.release(new IIDHabboMessenger());
               this.var_468 = null;
            }
            this.var_141 = null;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_88)
         {
            this.var_88.getHabboMainConnection(null).send(new FollowFriendMessageComposer(param1));
            this.var_88.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_666,const_665,const_1520));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_468)
         {
            this.var_468.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false));
            if(this.var_88)
            {
               this.var_88.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_666,const_665,const_1522));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_88)
         {
            this.var_88.getHabboMainConnection(null).send(new FindNewFriendsMessageComposer());
            this.var_88.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_666,const_665,const_1523));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_321)
         {
            if(!this.var_321.disposed)
            {
               if(!this.var_321.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_321.openFriendRequests();
                  }
                  else
                  {
                     this.var_321.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_321.mainWindow;
               ...
               if(this.var_88)
               {
                  this.var_88.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1066,const_1521,!!this.var_321.isOpen() ? const_1064 : const_1065));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_468)
         {
            if(!this.var_468.disposed)
            {
               this.var_468.toggleMessenger();
               if(this.var_88)
               {
                  this.var_88.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1066,const_1524,!!this.var_468.isOpen() ? const_1064 : const_1065));
               }
            }
         }
      }
      ...
      {
         this.var_88 = param2 as IHabboCommunicationManager;
         this.var_88.addHabboConnectionMessageEvent(new MessengerInitEvent(this.onMessengerInitialized));
         this.var_88.addHabboConnectionMessageEvent(new FriendListUpdateEvent(this.onFriendListUpdate));
         this.var_88.addHabboConnectionMessageEvent(new FindFriendsProcessResultEvent(this.onFindFriendProcessResult));
         this.var_88.addHabboConnectionMessageEvent(new NewBuddyRequestEvent(this.onNewFriendRequest));
         this.var_88.addHabboConnectionMessageEvent(new BuddyRequestsEvent(this.onFriendRequestList));
         this.var_88.addHabboConnectionMessageEvent(new NewConsoleMessageEvent(this.onNewConsoleMessage));
         this.var_88.addHabboConnectionMessageEvent(new RoomInviteEvent(this.onRoomInvite));
      }
      
      private function method_8(param1:IID, param2:IUnknown) : void
      {
         this.var_468 = param2 as IHabboMessenger;
      }
      
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_321 = param2 as IHabboFriendList;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         for each(_loc8_ in _loc5_)
         {
            ...
            if(_loc3_)
            {
               ...
               this.var_141.splice(this.var_141.indexOf(_loc3_),1);
            }
         }
         ...
         {
            this.var_141 = !!const_297 ? this.sortByNameAndOnlineStatus(this.var_141) : this.sortByName(this.var_141);
         }
