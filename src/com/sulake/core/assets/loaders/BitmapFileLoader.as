package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_1082 = new LoaderContext();
         this.var_1082.checkPolicyFile = true;
         ...
         {
            this.var_43.load(param2,this.var_1082);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_334 = 0;
         this.var_43.load(param1,this.var_1082);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_334 < var_2911)
            {
               ...
               this.var_43.load(new URLRequest(this.var_1075 + (this.var_1075.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_334),this.var_1082);
               return true;
            }
         }
         return false;
