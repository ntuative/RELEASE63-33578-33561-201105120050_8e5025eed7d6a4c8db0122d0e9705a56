package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_866:int = 0;
      
      protected var var_696:BitmapData;
      
      protected var var_2662:int;
      
      protected var var_1609:Boolean;
      
      protected var var_2133:Boolean;
      
      protected var var_2908:BitmapData;
      
      private var var_1362:Boolean;
      
      private const const_1892:Number = 1;
      
      private const const_1893:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2907 == FurniModel.const_40)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1504));
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_971)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1893;
               _loc1_.blend = this.const_1893;
            }
            else
            {
               this._window.blend = this.const_1892;
               _loc1_.blend = this.const_1892;
            }
         }
         if(this.isSelected)
         {
            this.var_1216.color = !!this.var_1362 ? uint(const_1347) : uint(const_1348);
         }
         else
         {
            this.var_1216.color = !!this.var_1362 ? uint(const_1349) : uint(const_1350);
         }
