package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureStickieLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_154,RoomObjectFurnitureActionEvent.const_477];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(object != null)
         {
            object.getModelController().setString(RoomObjectVariableEnum.const_1259,"");
         }
      }
      ...
      protected function setColorIndexFromItemData() : void
      {
         ...
         if(object != null)
         {
            _loc1_ = object.getModel().getString(RoomObjectVariableEnum.const_96);
            ...
            object.getModelController().setNumber(RoomObjectVariableEnum.const_256,_loc3_ + 1);
         }
      }
      ...
      override public function useObject() : void
      {
         ...
         if(eventDispatcher != null && object != null)
         {
            ...
            _loc3_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_477,_loc1_,_loc2_);
