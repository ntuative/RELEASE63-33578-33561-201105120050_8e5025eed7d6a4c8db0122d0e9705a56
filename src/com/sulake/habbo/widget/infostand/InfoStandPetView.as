package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1374:int = 152;
      
      private static const const_1363:int = 16;
      
      private static const const_638:int = 4;
      
      private static const const_1373:uint = 14342874;
      
      private static const const_1372:uint = 3815994;
      
      private static const const_1367:uint = 2085362;
      
      private static const const_1375:uint = 39616;
      
      private static const const_1366:uint = 10513106;
      
      private static const const_1371:uint = 8734654;
      
      private static const const_1376:uint = 9094430;
      
      private static const const_1368:uint = 6200576;
      
      private static const const_1370:String = "happiness";
      
      private static const const_1369:String = "experience";
      
      private static const const_1364:String = "energy";
      
      private static const const_1365:int = 250;
      
      private static const const_994:int = 25;
      
      private static const const_995:int = 5;
      ...
      private var var_201:PetCommandTool;
      ...
      {
         if(this.var_52 == null || this.var_47 == null || this.var_96 == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1370,param1.nutrition,param1.nutritionMax,const_1375,const_1367);
         this.updateStateElement(const_1369,param1.experience,param1.experienceMax,const_1371,const_1366);
         this.updateStateElement(const_1364,param1.energy,param1.energyMax,const_1368,const_1376);
         ...
         this.updateWindow();
         this.var_490 = param1.id;
         this._petData.remove(param1.id);
         this._petData.add(param1.id,param1);
         if(this.var_201 && this.var_201.isVisible() && param1.isOwnPet)
         {
            this.var_201.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_201.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1374,const_1363,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1373);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1372);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_638,_loc7_.width - 2,_loc7_.height - 2 - const_638);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_638);
      ...
      private function openTrainView() : void
      {
         if(this.var_201 == null)
         {
            this.var_201 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_490) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_201.showWindow(true);
            this.var_201.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for each(_loc10_ in _loc4_)
         {
            ...
            _loc10_.addEventListener(WindowEvent.const_43,this.onButtonResized);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_201 && this.var_201.getPetId() == this.var_490)
               {
                  this.var_201.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1817,true);
      ...
      {
         var _loc5_:* = null;
         var _loc1_:int = const_1365;
         this.var_96.width = _loc1_;
         var _loc2_:* = [];
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_994 + const_995;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_995;
            }
         }
         this.var_96.height = _loc4_ + const_994;
         this.updateWindow();
      }
   }
}
