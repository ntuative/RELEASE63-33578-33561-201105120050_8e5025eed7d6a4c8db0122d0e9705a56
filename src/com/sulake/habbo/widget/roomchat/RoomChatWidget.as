package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1555:int = 9;
      ...
      private static const const_1075:int = 4000;
      
      private static const const_1556:int = 6000;
      
      private static const const_1554:int = 3;
      ...
      private static const const_1073:int = (const_670 + const_456) * const_114 + const_114;
      
      private static const const_455:int = 9;
      
      private static const const_1558:int = 200;
      ...
      private var var_402:IItemListWindow;
      ...
      private var var_1063:Number = 1;
      
      private var _originalScale:Number = 0;
      
      private var var_853:Point;
      ...
      private var var_1064:int = 18;
      
      private var var_2968:int = 100;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component, param7:IHabboQuestEngine)
      {
         ...
         this.var_853 = new Point();
         super(param1,param2,param3);
         this._questEngine = param7;
         this._config = param4;
         this.var_2858 = param5;
         this.var_42 = param1.createWindow("chat_container","",HabboWindowType.const_79,HabboWindowStyle.const_30,HabboWindowParam.const_46,new Rectangle(0,0,200,this.var_236 + RoomChatHistoryPulldown.const_88),null,0) as IWindowContainer;
         this.var_42.background = true;
         this.var_42.color = 33554431;
         this.var_42.tags.push("room_widget_chat");
         this.var_402 = param1.createWindow("chat_contentlist","",HabboWindowType.const_1162,HabboWindowStyle.const_46,0 | 0,new Rectangle(0,0,200,this.var_236),null,0) as IItemListWindow;
         this.var_42.addChild(this.var_402);
         this.var_127 = param1.createWindow("chat_active_content","",HabboWindowType.const_79,HabboWindowStyle.const_46,HabboWindowParam.const_65,new Rectangle(0,0,200,this.var_236),null,0) as IWindowContainer;
         this.var_127.clipping = false;
         this.var_402.addListItem(this.var_127);
      ...
      {
         var _loc2_:int = 0;
         if(getTimer() > this.var_1319 && this.var_1319 > 0)
         {
            this.var_1319 = -1;
            this.animationStart();
         }
         if(this.var_938)
         {
            _loc2_ = param1 / const_1557 * const_1554;
            if(_loc2_ + this.var_1062 > this.var_1064)
            {
               _loc2_ = this.var_1064 - this.var_1062;
            }
            if(_loc2_ > 0)
            {
            ...
            if(this.var_1062 >= this.var_1064)
            {
               this.var_1064 = const_114;
               this.var_1062 = 0;
               this.animationStop();
               this.processBuffer();
               this.var_1319 = getTimer() + const_1075;
            }
         }
         if(this.var_28 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_758,this.onChatMessage);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_494,this.onRoomViewUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_758,this.onChatMessage);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_494,this.onRoomViewUpdate);
      ...
      private function onChatMessage(param1:RoomWidgetChatUpdateEvent) : void
      {
         ...
         if(this.var_1063 != 1)
         {
            _loc2_.senderX /= this.var_1063;
         }
         _loc2_.senderX -= this.var_853.x;
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            ...
            {
               this.var_1063 = param1.scale / this._originalScale;
            }
         }
         if(param1.positionDelta != null)
         {
            this.var_853.x += param1.positionDelta.x / this.var_1063;
            this.var_853.y += param1.positionDelta.y / this.var_1063;
         }
         if(param1.rect != null)
         {
            if(this.var_28 == null)
            ...
            this.var_402.width = this.var_42.width - this.var_28.scrollbarWidth;
            this.var_402.height = this.var_236;
            this.var_402.x = this.var_42.x;
            this.var_402.y = this.var_42.y;
            this.var_127.width = this.var_42.width - this.var_28.scrollbarWidth;
            this.var_127.height = this.var_236;
      ...
      private function processBuffer() : void
      {
         ...
         while(this.var_69.length > const_1553 || this.historyViewerActive() && this.var_69.length > 0)
         {
         ...
         else
         {
            ...
            {
               this.var_1064 = this.getItemSpacing(this._itemList[this._itemList.length - 1],this.var_69[0]);
            }
            else
            {
               this.var_1064 = const_114;
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_456 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timeStamp >= const_1556)
               {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         this.var_2859 = !!this._questEngine.isTrackerVisible() ? int(const_1558) : 0;
         var _loc2_:Number = (param1.senderX + this.var_853.x) * this.var_1063;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = -this.var_42.width / 2 - const_1074 + this.var_2968;
         var _loc6_:Number = this.var_42.width / 2 + const_1074 - this.var_28.scrollbarWidth - this.var_2859;
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            {
               param1.y = this.getAreaBottom() - (_loc3_ + 1) * const_114 - const_455;
            }
            else
            {
      ...
      {
         return "chat_" + this.var_2858.toString() + "_item_" + (this.var_2860++).toString();
      }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc7_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_533,param1,param3);
         messageListener.processWidgetMessage(_loc7_);
         var _loc8_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_903,param1,param2,param4,param5);
      ...
      {
         var _loc2_:int = this.var_42.context.getDesktopWindow().height - 0 - const_1552;
         param1 = Math.min(param1,_loc2_);
         this.var_236 = param1 - this.var_42.y;
         this.var_42.height = this.var_236 + RoomChatHistoryPulldown.const_88;
         if(this.var_28 != null)
         {
            this.var_28.containerResized(this.var_42.rectangle);
         }
      ...
      public function resetArea() : void
      {
         ...
         this.animationStop();
         this.var_236 = const_1073 + const_455;
         this.var_42.height = this.var_236 + this.var_28.pulldownBarHeight;
         this.var_402.width = this.var_42.width - this.var_28.scrollbarWidth;
         this.var_402.height = this.var_236;
         this.var_127.width = this.var_42.width - this.var_28.scrollbarWidth;
         if(this.historyViewerActive())
         {
            this.var_127.height = this.getTotalContentHeight() + const_455;
         }
         else
         {
            this.var_127.height = this.var_236;
         }
         this.var_402.scrollV = 1;
         if(!this.historyViewerActive())
         {
            this.var_28.containerResized(this.var_42.rectangle);
         }
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_1138)
         {
            this.resetArea();
            return;
         }
      ...
      public function mouseUp() : void
      {
         ...
         if(this.var_2081 && !this.historyViewerActive())
         {
            this.resetArea();
            this.var_2081 = false;
         }
