package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2396 = new RoomThumbnailRenderer(param1);
         this.var_957 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_189,this.var_123);
         if(this.var_123.ownerName != "" && this.var_123.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_189,!!this.var_123.event ? this.getEventCtg(this.var_123.categoryId) : this.getRoomCtg(this.var_123.categoryId));
         this.refreshRoomDesc(this.var_189,this.var_123);
         this.refreshExtraCont();
         this.refreshInfo(this.var_189,"trading_allowed",this.var_123.allowTrading);
         this.refreshInfo(this.var_189,"doormode_doorbell",this.var_123.doorMode == 1);
         this.refreshInfo(this.var_189,"doormode_password",this.var_123.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_189,this.var_123.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_957.refreshTags(_loc1_,this.var_123.tags);
         this.refreshTextWithCaption("rating",_loc1_,"" + this.var_123.score);
         if(this.var_123.event)
         {
            this.refreshTextWithCaption("startedat",_loc1_,"" + this.var_123.eventCreationTime);
         }
         this.var_2396.refreshThumbnail(_loc1_,this.var_123.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_202,Tabs.const_290,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
