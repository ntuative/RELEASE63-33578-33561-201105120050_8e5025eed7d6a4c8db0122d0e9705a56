package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_789:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2331 = param2.pickerUserId;
         this.var_2579 = param2.pickerUserName;
         this.var_1522 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_790 == null || param1.timeStamp < this.var_790.timeStamp)
         {
            this.var_790 = param1;
         }
         if(this.var_789 == null || param1.priority > this.var_789.timeStamp)
         {
            this.var_789 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_789;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_790;
         if(_loc2_ == null)
         {
