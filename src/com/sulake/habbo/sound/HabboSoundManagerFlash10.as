package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1526:int = 60;
      
      private static const const_1528:int = 25165823;
      ...
      private var var_788:Number = 1.0;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_968,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            this.var_1046.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_788;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_685.add(_loc4_,param1);
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_273,events);
         _loc5_.volume = this.var_788;
      ...
      public function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_273.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1045.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_175.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2807 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1045 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_175 == null || this._connection == null || this._roomEngine == null || this.var_221 != null)
         {
            return;
         }
         this.var_221 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_221.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1776,this.var_839));
         this.var_839 = -1;
         this.var_840 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_788 * 100)));
         }
      }
      ...
      {
         this.var_788 = param1;
         this.var_221.updateVolume(this.var_788);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         {
            _loc2_ = this.var_685.remove(param1);
            if(this.var_273.getValue(_loc2_) == null)
            {
               this.var_1575.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1575,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1575,_loc2_,TraxSample.const_1849,TraxSample.const_1592);
               this.var_273.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         if(this.var_1289.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1526 && this.var_1289.length > 0)
            {
               _loc3_ = this.var_1289.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_685.length == 0 && this.var_839 != -1)
            {
               this.var_840.ready = true;
               _loc4_ = this.var_839;
               this.var_839 = -1;
               this.var_840 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_968,_loc4_));
               if(this.var_2807)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_840 == null && this.var_1290.length > 0)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_968,_loc1_));
               }
               else
               {
                  this.var_840 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:* = [];
         var _loc3_:Array = this.var_221.samplesIdsInUse;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_273.length)
         {
            _loc5_ = this.var_273.getKey(_loc4_);
            _loc6_ = this.var_273.getWithIndex(_loc4_);
         ...
         if(_loc1_ > const_1528)
         {
            ...
            if(_loc7_.length > 0)
            {
               for each(_loc11_ in _loc7_)
               {
                  ...
                  _loc12_ = this.var_273.getValue(_loc11_) as TraxSample;
                  _loc12_.dispose();
                  this.var_273.remove(_loc11_);
               }
               this.var_221.samplesUnloaded(_loc7_);
            }
         }
      }
