package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1836:Point;
      
      private var var_525:IItemGridWindow;
      
      private var var_1462:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1836 = new Point(this.var_84.x,this.var_84.y);
         this.var_525 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1462 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1837 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_525 != null)
         {
            this.var_525.visible = false;
            this.var_525.destroyGridItems();
         }
         ...
         this.var_1183.y = this.var_959.y + this.var_959.height;
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_531:
                  _loc6_ = this.var_1837.clone();
                  if(this.var_525 != null)
                  {
                     this.var_525.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_525,this.var_1462,this.var_2024);
                     ...
                     case ProductTypeEnum.const_206:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_317,AvatarAction.const_486);
                              _loc16_.appendAction(AvatarAction.const_336,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2510)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2510 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_84 != null && true)
         {
            ...
            this.var_84.x = this.var_1836.x;
            this.var_84.y = this.var_1836.y;
            if(param3 != null)
            {
