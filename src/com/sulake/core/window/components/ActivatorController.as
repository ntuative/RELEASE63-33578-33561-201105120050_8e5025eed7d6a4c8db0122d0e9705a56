package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_324)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1098)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_875;
         if(this.var_875 != param1)
         {
            if(this.var_875 != null)
            {
               if(!this.var_875.disposed)
               {
                  this.var_875.deactivate();
               }
            }
            this.var_875 = param1;
