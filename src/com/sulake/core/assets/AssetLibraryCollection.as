package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1082:LoaderContext;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_1082 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_474 = new AssetLibrary("lib-" + this.var_571++);
         this.var_29.push(this.var_474);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_1082;
         }
      ...
      {
         return this.var_474.method_1(param1,param2);
      }
