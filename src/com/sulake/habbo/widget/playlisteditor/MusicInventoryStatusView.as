package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_719:String = "MISV_BUY_MORE";
      
      public static const const_882:String = "MISV_PREVIEW_PLAYING";
      ...
      private var var_1933:ITextWindow;
      
      private var var_1932:ITextWindow;
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_1932.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_882,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_719,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_413.add(const_882,_loc1_);
            this.var_1933 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1932 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_493));
         ...
         if(_loc1_ != null)
         {
            this.var_413.add(const_719,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_562));
         }
      }
