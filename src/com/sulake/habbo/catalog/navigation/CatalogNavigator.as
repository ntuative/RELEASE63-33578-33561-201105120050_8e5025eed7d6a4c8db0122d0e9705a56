package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2992:String = "magic.credits";
      
      private var var_2946:String = "magic.pixels";
      
      private var var_2945:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2946);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2945,true);
      }
