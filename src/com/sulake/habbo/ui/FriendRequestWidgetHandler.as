package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_748);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_795);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_748:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_795:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_147);
         _loc1_.push(FriendRequestEvent.const_62);
         _loc1_.push(FriendRequestEvent.const_334);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_147:
            ...
            case FriendRequestEvent.const_334:
