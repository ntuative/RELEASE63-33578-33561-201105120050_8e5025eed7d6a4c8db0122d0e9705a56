package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2138:Boolean = false;
      ...
      protected var var_1076:Boolean = true;
      
      protected var var_478:Boolean = false;
      
      protected var var_1338:Boolean = false;
      
      protected var var_2140:int = 0;
      
      protected var var_2139:int = 0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_174 = var_477 || !testParamFlag(WindowParam.const_34);
         this._container = _context.create("_CONTAINER","",WindowType.const_429,WindowStyle.const_133,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_700)
         {
            ...
            _loc2_ = WindowEvent.allocate(WindowEvent.const_597,this,null);
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_606,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_516,param1);
            }
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_193:
               if(this.var_1335)
               {
                  this.var_1336 = this.var_2140 - _loc3_;
                  this.var_1337 = this.var_2139 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1336 != 0 && this.var_109 != 0)
                     {
                        this.scrollH += this.var_1336 / this.var_109;
                     }
                  }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1076 && !this.var_565 && this._container)
         {
            this.var_565 = true;
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_422,this._spacing,PropertyStruct.const_42,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1121);
         }
         if(this.var_1076 != PropertyDefaults.const_1141)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_682,this.var_1076,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1772);
         }
         if(this.var_478 != PropertyDefaults.const_1256)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_803,this.var_478,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1752);
         }
         if(this.var_1338 != PropertyDefaults.const_1323)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_823,this.var_1338,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1684);
         }
         if(this.var_699 != PropertyDefaults.const_1301)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_705,this.var_699,PropertyStruct.const_119,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1672);
         }
         if(this.var_701 != PropertyDefaults.const_1210)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_727,this.var_701,PropertyStruct.const_119,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_422:
               ...
               case PropertyDefaults.const_823:
                  ...
                  break;
               case PropertyDefaults.const_682:
                  this.var_1076 = _loc2_.value as Boolean;
                  break;
