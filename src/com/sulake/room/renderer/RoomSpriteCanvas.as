package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1434:int = 50;
      
      private static const const_1021:Number = 60;
      
      private static const const_1433:Number = 50;
      ...
      private var var_630:RoomObjectCache;
      
      private var var_517:Array;
      
      private var var_632:Array;
      
      private var var_1446:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2485:Number = -1.0E7;
      
      private var var_2479:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_253.addChild(this.var_97);
         ...
         this.var_630 = new RoomObjectCache(_loc6_);
         this.var_712 = new ColorTransform();
         this.var_631 = new Matrix();
      ...
      {
         this.var_520.x -= param1 - this.var_634;
         this.var_634 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_520.y -= param1 - this.var_635;
         this.var_635 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_966 = true;
            if(this.var_135 != null && !this.var_253.contains(this.var_135))
            {
               this.var_253.addChild(this.var_135);
         ...
         else if(!param1 && this.var_966)
         {
            ...
            if(this.var_135 != null && this.var_253.contains(this.var_135))
            {
               this.var_253.removeChild(this.var_135);
      ...
      {
         this.var_630.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_1814 = !this.var_1814;
         ...
         if(this.var_519 != this.var_2481 || this.var_518 != this.var_2482)
         {
            _loc8_ = true;
         }
         if(this.var_97.x != this.var_634 || this.var_97.y != this.var_635)
         {
            this.var_97.x = this.var_634;
            this.var_97.y = this.var_635;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_517[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2481 = this.var_519;
         this.var_2482 = this.var_518;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1447 > 0)
         {
            _loc2_ = param1 - this.var_1447;
            if(_loc2_ > const_1021 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2480 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_759;
               if(this.var_759 == const_365 + 1)
               {
                  this.var_531 = _loc2_;
                  this.var_1813 = this.var_2483;
               }
               else if(this.var_759 > const_365 + 1)
               {
                  _loc3_ = Number(this.var_759 - const_365);
                  this.var_531 = this.var_531 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1813 = this.var_1813 * (_loc3_ - 1) / _loc3_ + Number(this.var_2483) / _loc3_;
                  if(this.var_759 > const_365 + const_1434)
                  {
                     this.var_759 = const_365;
                     if(!this.var_1167 && this.var_531 > const_1021)
                     {
                        this.var_1167 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1167 && this.var_531 < const_1433)
                     {
                        this.var_1167 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_630.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_630.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1814 && this.var_1167);
         ...
         _loc13_ += int(this.var_519 / 2);
         _loc14_ += int(this.var_518 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_634;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_635;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_634;
                     _loc17_.y = _loc20_ - this.var_635;
      ...
      {
         if(param1 < this.var_519 && param1 + param3 >= 0 && (param2 < this.var_518 && param2 + param4 >= 0))
         {
            if(!this.var_2940)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_519)
         {
            param3 -= this.var_519 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_518)
         {
            param4 -= this.var_518 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2484)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_947)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(param2 < 0 || param2 >= this.var_947)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_760 || this.var_760 == 0)
         {
            _loc4_ = this.var_947 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_631.identity();
            if(flipH)
            {
               this.var_631.scale(-1,1);
               this.var_631.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_631.scale(1,-1);
               this.var_631.translate(0,data.height);
            }
            finalData.draw(data,this.var_631);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_712.redMultiplier = tR;
            this.var_712.greenMultiplier = tG;
            this.var_712.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_712);
            if(name.length > 0)
            {
               this.var_252.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1166 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1815;
         }
         this.var_1815 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1166;
         return this.var_1815;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_519 / 2;
         var _loc12_:Number = param2 - this.var_518 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1812,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_633.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_633.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2485 || param2 != this.var_2479)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_633.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_633.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_355 != null && param1 != null)
         {
            this.var_355.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_355 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_355.getKey(_loc1_);
            _loc3_ = this.var_355.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1446.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
