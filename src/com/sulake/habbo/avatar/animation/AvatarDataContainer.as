package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2601:uint;
      
      private var var_2599:uint;
      ...
      private var var_1673:Number = 1.0;
      
      private var var_1674:Number = 1.0;
      
      private var var_1675:Number = 1.0;
      ...
      {
         super();
         this.var_1903 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2601 = parseInt(_loc2_,16);
         this.var_2599 = parseInt(_loc3_,16);
         ...
         this.var_712 = new ColorTransform(this.var_1673,this.var_1674,this.var_1675,this._alphaMultiplier);
         this.var_1205 = this.generatePaletteMapForGrayscale(this.var_2599,this.var_2601);
      }
      ...
      {
         return this.var_1205.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1205.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1205.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1205.getValue("alphas") as Array;
      }
