package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1384:String = "service-libraries";
      
      private static const const_1378:String = "library";
      
      private static const const_1382:String = "component-libraries";
      
      private static const const_1381:String = "library";
      
      private static const const_1380:String = "error_data";
      
      private static const const_1386:String = "error_cat";
      ...
      private var var_734:IEventDispatcher;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_722:
               ...
               var_408.addChild(new ProfilerViewer(this.var_204));
               break;
            case Core.const_564:
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1380,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1386,String(param3));
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_734 = loadingEventDelegate;
         if(this.var_345 == null)
         {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_312,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_312,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_312,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1588);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_734)
         {
            this.var_734.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_734)
         {
            ...
            this.var_734.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_734)
                  {
                     this.var_734.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_501 - this.var_345.length,this.var_501,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_204 ? 0 : this.var_1402 & 0;
         if(_loc3_ == Core.const_564)
         {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_105)
         {
            ...
            {
               if(this.var_604[priority] < priority)
               {
                  ++this.var_604[priority];
                  skip = true;
               }
            }
            if(!skip)
