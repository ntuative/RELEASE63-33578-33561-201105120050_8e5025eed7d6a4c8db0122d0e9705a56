package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_454:uint = 3;
      
      private static const const_1545:uint = 1;
      ...
      private var var_1043:ISkinContainer;
      
      private var var_277:Array;
      
      private var var_1587:IEventDispatcher;
      
      private var var_1309:Boolean = false;
      
      private var var_2060:ProfilerOutput;
      
      private var var_1586:ProfilerAgentTask;
      
      private var var_1588:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1043 = new SkinContainer(_loc4_.content as XML,assets);
         this._windowRenderer = new WindowRenderer(this.var_1043);
         this.var_213 = new Array(const_454);
         ...
         this.var_278 = this.var_213[const_1545];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2060)
            {
               this.var_2060 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_2060.profiler = _loc3_;
            this.var_1586 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1586);
            this.var_1588 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1588);
            this.var_1309 = true;
         }
      }
      ...
      {
         var _loc3_:Dictionary = this.var_277[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_277[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_1043.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_213[param1].getDesktopWindow().getChildAt(this.var_278.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1587.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_454 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1587.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_454)
         {
         ...
         this.var_1587.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1670,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1686,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.method_4({
            "type":WindowType.const_592,
            "style":WindowStyle.const_133,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
