   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_66,FigureData.const_239,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_66,FigureData.const_259,_windowManager,_assetLibrary);
         }
         else
         {
