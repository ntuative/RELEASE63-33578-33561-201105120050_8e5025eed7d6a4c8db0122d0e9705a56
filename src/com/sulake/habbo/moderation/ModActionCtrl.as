package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1270:IDropMenuWindow;
      ...
      private var var_1029:OffenceCategoryData;
      
      private var var_1030:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1268 = IButtonWindow(this.var_33.getXmlWindow("modact_offence"));
         this.var_1269 = IButtonWindow(this.var_33.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1772;
         ...
         this.var_1270 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1270);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1029 != null;
         if(this.var_1030 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1030.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1029 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1029.offences,this.var_1268,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_33.initMsg.offenceCategories,this.var_1269,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1579;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModAlertMessageComposer(this.var_1558,this.var_547.text,this.var_1559));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1029 = this.var_33.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1030 = this.var_1029.offences[_loc3_];
         this.var_547.text = this.var_1030.msg;
         this.var_689 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModKickMessageComposer(this.var_1558,this.var_547.text,this.var_1559));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1270.selection < 0)
         {
            this.var_33.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_33.connection.send(new ModBanMessageComposer(this.var_1558,this.var_547.text,this.getBanLength(),this.var_1559));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1270.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1268.destroy();
            this.var_1268 = null;
         }
         if(this.var_1269 != null)
         {
            this.var_1269.destroy();
            this.var_1269 = null;
         }
         this.var_1270 = null;
         this.var_547 = null;
