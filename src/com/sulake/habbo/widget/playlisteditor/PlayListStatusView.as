package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_689:String = "PLSV_ADD_SONGS";
      
      public static const const_1296:String = "PLSV_START_PLAYBACK";
      ...
      {
         if(this.var_44 != const_484)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_413[this.var_44];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_413[const_689];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_413.add(const_484,_loc1_);
