package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2209:int = 1000;
      ...
      private var var_1067:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_206 = new Timer(this.const_2209);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_194.isActive)
         {
            ...
            this.var_1068.width = _loc2_ * this.var_299;
         }
         else
         {
            this.var_1068.width = 0;
            this.var_206.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_855 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_855 == null)
            {
               return;
            }
         ...
         if(!this.var_194.isActive)
         {
            this.var_855.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_855.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_855.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_1067 = this._window.findChildByName("effect_hilite");
            this.var_1067.visible = false;
         }
         this.setTimeLeft();
         this.var_1068 = this._window.findChildByName("loader_bar");
         if(this.var_1068 != null)
         {
            this.var_299 = this.var_1068.width;
            this.var_206.start();
            this.onUpdate();
         }
