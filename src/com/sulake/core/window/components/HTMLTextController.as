package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_895:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_718:String;
      
      private var var_1109:String = null;
      
      private var var_1678:StyleSheet = null;
      ...
      {
         this.var_718 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1109 == param2)
         {
            return;
         }
         param1.var_1109 = param2;
         param1.var_1678 = null;
         if(param1.var_1109 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1109);
            param1.var_1678 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_813.indexOf(param1) > -1)
         {
            this.var_718 = param1;
         }
      }
      ...
      {
         return this.var_718 == LinkTarget.const_30 ? defaultLinkTarget : this.var_718;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1678;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1180)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_718 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_898,this.var_718,PropertyStruct.const_52,true,PropertyDefaults.const_813));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_718 = _loc2_.value as String;
               break;
            }
