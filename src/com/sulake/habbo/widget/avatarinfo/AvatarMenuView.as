package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1329:uint = 0;
      
      protected static const const_360:uint = 1;
      
      protected static const const_981:uint = 2;
      
      protected static var var_1353:uint = const_360;
      
      private static const const_1341:uint = 4281149991;
      
      private static const const_1339:uint = 4283715916;
      
      private static const const_1338:uint = 16777215;
      
      private static const const_1340:uint = 9552639;
      
      private static const const_1342:uint = 16744755;
      
      private static const const_1337:uint = 16756591;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1332)
         {
            ...
            {
               this.var_333 = const_981;
            }
            else
            {
               this.var_333 = var_1353;
            }
         }
         if(this.var_333 == const_1329)
         {
         ...
         if(this.var_333 == const_1329 || this.var_333 == const_360)
         {
            ...
            else
            {
               ...
               this.var_333 = const_360;
            }
         }
         if(this.var_333 == const_360)
         {
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == "button")
            {
               param2.color = const_1339;
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               if(param2.tags.indexOf("actions") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1340;
               }
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1342;
               }
            }
         }
         if(_loc3_)
