package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1105:String = "AssetLibraryReady";
      
      public static const const_929:String = "AssetLibraryLoaded";
      
      public static const const_1747:String = "AssetLibraryUnloaded";
      
      public static const const_1622:String = "AssetLibraryLoadError";
      
      private static const const_452:String = "name";
      
      private static const const_1011:String = "asset";
      
      private static const const_1012:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1010:String = "library";
      
      private static var var_302:Dictionary;
      
      private static var var_1781:LazyAssetProcessor = new LazyAssetProcessor();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         if(var_302 == null)
         {
            ...
            this.method_1(new AssetTypeDeclaration("application/octet-stream",UnknownAsset,BinaryFileLoader));
            this.method_1(new AssetTypeDeclaration("application/x-shockwave-flash",DisplayAsset,BitmapFileLoader,"swf"));
            this.method_1(new AssetTypeDeclaration("application/x-font-truetype",FontAsset,BinaryFileLoader,"ttf","otf"));
            this.method_1(new AssetTypeDeclaration("application/zip",UnknownAsset,ZipFileLoader,"zip"));
            this.method_1(new AssetTypeDeclaration("text/xml",XmlAsset,BinaryFileLoader,"xml"));
            this.method_1(new AssetTypeDeclaration("text/html",XmlAsset,BinaryFileLoader,"htm","html"));
            this.method_1(new AssetTypeDeclaration("text/plain",TextAsset,BinaryFileLoader,"txt"));
            this.method_1(new AssetTypeDeclaration("image/jpeg",BitmapDataAsset,BitmapFileLoader,"jpg","jpeg"));
            this.method_1(new AssetTypeDeclaration("image/gif",BitmapDataAsset,BitmapFileLoader,"gif"));
            this.method_1(new AssetTypeDeclaration("image/png",BitmapDataAsset,BitmapFileLoader,"png"));
            this.method_1(new AssetTypeDeclaration("image/tiff",BitmapDataAsset,BitmapFileLoader,"tif","tiff"));
            this.method_1(new AssetTypeDeclaration("sound/mp3",SoundAsset,SoundFileLoader,"mp3"));
         }
         ++var_512;
         this.var_424 = new Dictionary(false);
         this.var_511 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_616 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1010);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1011);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_452);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1012);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_616 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_931.splice(var_931.indexOf(this),1);
            --var_512;
            this.var_511 = null;
            this.var_928 = null;
            this.var_160 = null;
      ...
      {
         if(this.var_616 == param1.url && this.var_930)
         {
            if(!this.var_929 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_617);
            }
            this.var_929 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1105));
         }
         else
         {
      ...
      {
         var _loc2_:Class = this.var_928[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_511[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1219,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1234,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1115,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1158,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_511[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_511[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_426;
                     this.var_425.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_511[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_425.length ? this.getAssetByName(this.var_425[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_160)
         {
            ...
            {
               return this.var_425.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_160[param1] != null || (this.var_617 != null ? this.var_617[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1781.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_160)
            {
               if(this.var_160[_loc2_] == param1)
               {
                  this.var_425.splice(this.var_425.indexOf(_loc2_),1);
      ...
      public function method_1(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
         ...
         {
            if(this.var_424.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_424[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_424[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_424)
         {
            _loc3_ = AssetTypeDeclaration(this.var_424[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_424)
         {
            _loc4_ = AssetTypeDeclaration(this.var_424[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_617 = _loc2_.resource;
         this.var_616 = _loc2_.url;
         if(this.var_929)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_617);
         }
         this.var_930 = true;
         dispatchEvent(new Event(AssetLibrary.const_929));
         dispatchEvent(new Event(AssetLibrary.const_1105));
         if(this.var_929)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1622));
         this.var_43 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1010);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1011);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_452).toString() == param1)
               {
                  _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_616 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_617[param1]);
                  _loc6_ = _loc3_.child(const_1012);
                  if(_loc6_.length())
                  {
