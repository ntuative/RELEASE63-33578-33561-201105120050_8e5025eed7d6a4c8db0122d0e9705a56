package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1908:int = 0;
      
      private const const_1911:int = 1;
      
      private const const_1907:int = 2;
      
      private const const_1913:int = 3;
      
      private const const_1912:int = 4;
      
      private const const_2196:int = 0;
      
      private const const_2194:int = 1;
      
      private const const_2192:int = 2;
      
      private const const_2195:int = 3;
      
      private const const_2190:int = 4;
      
      private const const_2188:int = 5;
      
      private const const_1909:String = "deco_img";
      
      private const const_1910:String = "dialog_bg";
      
      private const const_2189:String = "%campaign%_dialog_bg.png";
      
      private const const_366:String = "%campaign%_gift_package.png";
      
      private const const_2191:String = "%campaign%_gift_content.png";
      
      private const const_2193:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1517 = this.var_145.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1517 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1514.length)
         {
            _loc2_ = this.var_1514.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_145 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_598,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_788,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_814,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_598,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_598:
               _loc2_ = this.const_1908;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_814:
         ...
         if(this._window && (this.var_1515 != _loc2_ || _loc3_ != this.var_186))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1515)
            {
               ...
               case this.const_1911:
                  if(this.var_405 == this.const_2196)
                  {
                  ...
                  else if(this.var_405 == this.const_2194)
                  {
                  ...
                  else if(this.var_405 == this.const_2192)
                  {
                  ...
                  else if(this.var_405 == this.const_2195)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_405 == this.const_2190)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_186,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_405 == this.const_2188)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2189.replace("%campaign%",this.var_186);
            this.setDecoImage(_loc5_,this.const_1910);
            _loc2_ = _loc2_.replace("%campaign%",this.var_186);
            this.setDecoImage(_loc2_,this.const_1909);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_751);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1516 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1516 == 1 ? "null" : InventoryCategory.const_127);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_932,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1514.push(new ImageDownloader(this,_assets,this.var_186,this.var_1517,param1,param2));
            return;
         }
