package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_455);
         if(_loc1_)
         {
      ...
      {
         if(this.var_455 != param1.name)
         {
            this.var_455 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2508 = _loc2_.textWidth;
         this.var_2509 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_366 != _loc2_.color : this.var_366 != null && this.var_366 != PropertyDefaults.const_709) ? new PropertyStruct(PropertyDefaults.const_430,this.var_366,PropertyStruct.const_134,true) : PropertyDefaults.const_1262);
         if(this.var_41)
         {
            if(this.var_41.left != PropertyDefaults.const_677)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_262,this.var_41.left,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_767);
            }
            if(this.var_41.top != PropertyDefaults.const_840)
            {
            ...
            if(this.var_41.right != PropertyDefaults.const_910)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_248,this.var_41.right,PropertyStruct.const_42,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_953);
            }
            if(this.var_41.bottom != PropertyDefaults.const_862)
            {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_437:
                  ...
                  break;
               case PropertyDefaults.const_430:
