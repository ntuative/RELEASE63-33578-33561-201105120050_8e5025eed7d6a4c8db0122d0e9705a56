package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_718,RoomWidgetPresentOpenMessage.const_172];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_718:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc6_ = _loc5_.getString(RoomObjectVariableEnum.const_96);
                     if(_loc6_ == null)
                     {
                        _loc6_ = "";
                     }
                     _loc6_ = _loc6_.substr(1);
                     _loc7_ = _loc5_.getNumber(RoomObjectVariableEnum.const_279);
                     _loc8_ = _loc5_.getString(RoomObjectVariableEnum.const_322);
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_66:
                           if(_loc3_ != null && _loc3_.name == const_106)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_631,0,this._container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == TYPE_LANDSCAPE)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_534,0,this._container.localization.getKey("inventory.furni.item.landscape.name"),false,null);
                           }
                           ...
                           {
                              if(_loc3_ != null && _loc3_.name == const_1441)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_305:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_504,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
