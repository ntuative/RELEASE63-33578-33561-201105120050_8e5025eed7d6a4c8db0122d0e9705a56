package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_296:MainViewCtrl;
      
      private var var_611:RoomInfoViewCtrl;
      
      private var var_1136:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_461:Tabs;
      ...
      private var var_2396:RoomThumbnailRenderer;
      
      private var var_1050:GuestRoomPasswordInput;
      
      private var var_293:GuestRoomDoorbell;
      
      private var var_1137:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2395 = new Array();
         ...
         this.var_296 = new MainViewCtrl(this);
         this.var_611 = new RoomInfoViewCtrl(this);
         this.var_1136 = new RoomCreateViewCtrl(this);
         this.var_2396 = new RoomThumbnailRenderer(this);
         this.var_1050 = new GuestRoomPasswordInput(this);
         this.var_293 = new GuestRoomDoorbell(this);
         this.var_461 = new Tabs(this);
         this.var_1137 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_331,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      {
         var _loc1_:Boolean = this.var_296.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_296.startSearch(Tabs.const_202,Tabs.const_370,param1);
         this.var_296.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_296.startSearch(Tabs.const_254,Tabs.const_287);
         this.var_461.getTab(Tabs.const_254).tabPageDecorator.tabSelected();
      }
      ...
      public function trackNavigationDataPoint(param1:String, param2:String, param3:String = null) : void
      {
