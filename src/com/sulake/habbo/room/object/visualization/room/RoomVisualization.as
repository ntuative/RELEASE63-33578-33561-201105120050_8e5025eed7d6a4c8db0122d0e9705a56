package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1729:int = 16777215;
      
      public static const const_1656:int = 13421772;
      
      private static const const_1057:int = 16777215;
      
      private static const const_1056:int = 13421772;
      
      private static const const_1054:int = 10066329;
      
      private static const const_1055:int = 10066329;
      
      public static const const_1653:int = 16777215;
      
      public static const const_1796:int = 13421772;
      
      public static const const_1609:int = 10066329;
      ...
      private var var_829:Rectangle = null;
      
      private var var_544:RoomPlaneBitmapMaskParser = null;
      
      private var var_1561:String = null;
      
      private var _floorType:String = null;
      
      private var var_1560:String = null;
      
      private var _floorThicknessMultiplier:Number = NaN;
      
      private var var_1437:Number = NaN;
      
      private var var_2010:String = null;
      
      private var var_1261:uint = 16777215;
      
      private var var_2772:int = 255;
      
      private var var_2768:int = 255;
      
      private var var_2769:int = 255;
      
      private var var_2008:Boolean = true;
      
      private var var_1262:int = 0;
      
      private var var_1688:int = -1000;
      
      private const const_2204:int = 250;
      ...
      private var var_2771:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_544 = new RoomPlaneBitmapMaskParser();
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_829 = super.boundingRectangle;
         }
         return new Rectangle(this.var_829.x,this.var_829.y,this.var_829.width,this.var_829.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1150);
         ...
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_251)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_243)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_417)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1653;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1796;
               }
               else
               {
                  _loc13_.color = const_1609;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1777)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_71,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1688 + this.const_2204 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_390.length)
            {
               _loc11_ = this.var_676[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_390[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2008)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2769 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2768 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2772 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1861)
         {
            this.var_1861 = param1.updateId;
            this.var_829 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1592 || _loc3_.y != this.var_2770 || _loc3_.z != this.var_2771 || param1.scale != this.var_2009))
            {
               this.var_1592 = _loc3_.x;
               this.var_2770 = _loc3_.y;
               this.var_2771 = _loc3_.z;
               this.var_2009 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1176);
            if(_loc3_ != this.var_2010)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2010 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_717));
            if(_loc4_ != this.var_1261)
            {
               this.var_1261 = _loc4_;
               this.var_2769 = this.var_1261 & 255;
               this.var_2768 = this.var_1261 >> 8 & 255;
               this.var_2772 = this.var_1261 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1111));
            if(_loc5_ != this.var_2008)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_190);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_205);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_195);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_926));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_692));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_834));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_146 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1120);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1118);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this._floorThicknessMultiplier || _loc3_ != this.var_1437))
            {
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_390;
         if(this.var_390.length == 0)
         {
            _loc6_ = this.var_140;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_390.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_390.push(_loc12_);
                        this.var_676.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1262;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_544.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_544.maskCount)
         {
            _loc10_ = this.var_544.getMaskType(_loc8_);
            _loc11_ = this.var_544.getMaskLocation(_loc8_);
            _loc12_ = this.var_544.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_71 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_275)
                              {
