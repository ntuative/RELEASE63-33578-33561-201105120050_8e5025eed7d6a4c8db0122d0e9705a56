package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1391:String = "_TITLE";
      
      private static const const_1393:String = "_HEADER";
      
      private static const const_1392:String = "_CONTENT";
      ...
      private var var_1409:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1391) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1409 = findChildByTag(const_1393) as IHeaderWindow;
            if(!this.var_1409)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_187 = findChildByTag(const_1392) as IWindowContainer;
            if(!this.var_187)
            {
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1333,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1079 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_299);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_235);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_255);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_235,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_235,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_333,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_262,_loc3_.left,PropertyStruct.const_42,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_246,_loc3_.top,PropertyStruct.const_42,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_248,0 - _loc3_.right,PropertyStruct.const_42,_loc2_));
