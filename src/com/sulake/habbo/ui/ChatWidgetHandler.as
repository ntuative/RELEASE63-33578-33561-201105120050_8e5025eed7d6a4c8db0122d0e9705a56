package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_824:Point = null;
      
      private var var_542:Vector3d;
      
      public function ChatWidgetHandler()
      {
         this.var_1249 = [];
         this.var_542 = new Vector3d();
         super();
      ...
      public function dispose() : void
      {
         ...
         if(this.var_457 != null)
         {
            ...
            {
               _loc2_ = this.var_457.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_736,RoomWidgetChatSelectAvatarMessage.const_903];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_736:
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_44) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1324))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_44) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1324))
                              {
                     ...
                     switch(_loc3_.chatType)
                     {
                        ...
                        case RoomWidgetChatMessage.const_131:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_150:
                           this._container.roomSession.sendWhisperMessage(_loc3_.recipientName,_loc3_.text);
                     }
                  }
               }
               break;
            case RoomWidgetChatSelectAvatarMessage.const_903:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_457.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_668.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_668.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_457.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_824 == null)
            {
               ...
               this.var_542.y = 0;
               this.var_542.z = 0;
               this.var_824 = _loc4_.getScreenPoint(this.var_542);
            ...
            this.var_542.y = 0;
            this.var_542.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_542);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_824.x || _loc8_.y != this.var_824.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_824,_loc5_));
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_457)
         {
            _loc2_ = this.var_457.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1249.push(_loc2_);
            }
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_668.add(param1,_loc7_);
                  }
               }
            }
         }
