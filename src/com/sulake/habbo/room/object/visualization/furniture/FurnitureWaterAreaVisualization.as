package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1432:String = "shore";
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1165)
            {
      ...
      {
         if(this.var_2467 == param1 && this.var_2468 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1432)
            {
               this.var_1806 = _loc2_;
               this.var_2467 = param1;
               this.var_2468 = direction;
               return this.var_1806;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1165.indexOf(_loc2_) < 0)
            {
               this.var_1165.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1807 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_437.length)
         {
            if(this.var_437[_loc5_] == true)
            {
               this.var_1807 = true;
            }
            _loc5_++;
      ...
      {
         var _loc2_:* = null;
         if(this.var_516 == 0 || this.var_628 == 0)
         {
            ...
            this.var_516 = _loc2_.getNumber(RoomObjectVariableEnum.const_308);
            this.var_628 = _loc2_.getNumber(RoomObjectVariableEnum.const_399);
         }
         this.var_437 = [];
         this.var_629 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_516 * 2 + this.var_628 * 2)
         {
            this.var_437.push(false);
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_68,getSize(param3),this.var_437,this.var_629,assetCollection);
      }
