package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_444:int = 1;
      
      private static const const_989:int = 2;
      ...
      {
         return this.var_585 != const_990;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1684 != RecyclerStatusMessageEvent.const_1222;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_585 == const_444;
      }
      ...
      {
         this.var_585 = const_989;
         this.var_111 = new Array(const_191);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1658:
               this.var_585 = const_444;
            ...
            case RecyclerStatusMessageEvent.const_1222:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1730:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1172:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1765:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_111.length < const_191)
         {
            return false;
         }
         var _loc1_:int = 0;
