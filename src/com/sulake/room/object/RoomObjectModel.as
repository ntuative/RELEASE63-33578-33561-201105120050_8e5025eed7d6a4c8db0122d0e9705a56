package com.sulake.room.object
{
   ...
   public class RoomObjectModel implements IRoomObjectModelController
   {
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_597)
            {
               delete this.var_597[_loc1_];
            }
            this.var_597 = null;
         }
      ...
      {
         var _loc2_:Array = this.var_598[param1];
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.slice();
         }
      ...
      {
         var _loc2_:Array = this.var_600[param1];
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.slice();
         }
      ...
      {
         if(this.var_1392.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      {
         if(this.var_1393.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1393.push(param1);
         }
         if(this.var_599[param1] != param2)
         {
            this.var_599[param1] = param2;
            ++this._updateID;
         }
      }
      ...
      public function setNumberArray(param1:String, param2:Array, param3:Boolean = false) : void
      {
         ...
         var _loc6_:Array = this.var_598[param1];
      ...
      public function setStringArray(param1:String, param2:Array, param3:Boolean = false) : void
      {
         ...
         var _loc6_:Array = this.var_600[param1];
         var _loc7_:Boolean = true;
         if(_loc6_ != null && _loc6_.length == _loc4_.length)
         {
            _loc5_ = _loc4_.length - 1;
