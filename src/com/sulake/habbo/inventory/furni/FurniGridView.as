   ...
   public class FurniGridView
   {
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_45)
         {
            ...
            this.var_66.toggleItemSelection(this._category,this.var_247.getGridItemIndex(param1.window));
            this.var_605 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_605 != null && this.var_605 == param2 && !this.var_66.isTradingOpen)
         {
