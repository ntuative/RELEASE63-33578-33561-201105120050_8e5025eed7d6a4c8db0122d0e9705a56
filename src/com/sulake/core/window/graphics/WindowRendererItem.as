package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private var var_125:BitmapData;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1572 = 4294967295;
         this.var_1044 = 0;
         this.var_712 = new ColorTransform();
         this.var_1085 = new Matrix();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this._drawBufferAllocator.free(this.var_125);
               this.var_125 = null;
            }
         }
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1067) : uint(const_667);
         var _loc6_:Boolean = this.var_192.width > 0 && this.var_192.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_1044))
            {
               _loc5_ = const_1068;
            }
         }
         ...
         if(_loc5_ != const_667)
         {
            if(this.var_125 == null)
            {
               this.var_125 = this._drawBufferAllocator.allocate(_loc8_,_loc9_,true,param1.color);
               this.var_684 = true;
               _loc6_ = true;
               _loc10_ = false;
            }
            else if(this.var_125.width != _loc8_ || this.var_125.height != _loc9_)
            {
               this._drawBufferAllocator.free(this.var_125);
               this.var_125 = this._drawBufferAllocator.allocate(_loc8_,_loc9_,true,param1.color);
               this.var_684 = true;
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_1068)
               {
                  ...
                  if(this.var_684)
                  {
                     ...
                     if(_loc10_)
                     {
                        this.var_125.fillRect(this.var_125.rect,param1.color);
                     }
                     _loc7_.draw(param1,this.var_125,this.var_125.rect,this.var_1044,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_34))
                  {
                     this.var_1085.tx = param2.x;
                     this.var_1085.ty = param2.y;
                     this.var_712.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_125,this.var_1085,this.var_712,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
                     _loc4_.copyPixels(this.var_125,param3,param2,null,null,true);
                  }
               }
      ...
      {
         var _loc2_:ISkinRenderer = this.var_1043.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_133)
            {
               _loc2_ = this.var_1043.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_133);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this.var_1043.getTheActualState(param1.type,param1.style,param1.state) != this.var_1572;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_885:
               this.var_1044 = this.var_1043.getTheActualState(param1.type,param1.style,param1.state);
               ...
               break;
            case WindowRedrawFlag.const_1295:
               if(param1.testParamFlag(WindowParam.const_34))
               {
                  this.var_684 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_1241:
               _loc4_ = true;
         }
         if(_loc4_)
         {
