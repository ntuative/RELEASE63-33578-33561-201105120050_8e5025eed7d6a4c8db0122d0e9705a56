package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_992:int = 3;
      
      public static const const_615:int = 2;
      
      public static const const_390:int = 1;
      
      public static const const_241:int = 0;
      
      public static const const_88:int = 39;
      
      private static const const_985:int = 150;
      
      private static const const_984:int = 250;
      ...
      private var var_2202:BitmapData;
      ...
      private var var_2198:BitmapData;
      
      private var var_2197:BitmapData;
      
      private var var_2201:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_42 = param3;
         this.var_2202 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1655 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2199 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1654 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1656 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2198 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2197 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_71 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_331,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,param3.width,param3.height - const_88),null,0,0) as IBitmapWrapperWindow;
         this.var_42.addChild(this.var_71);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_79,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_42.height - const_88,param3.width,const_88),null,0) as IWindowContainer;
         this.var_42.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_530,HabboWindowStyle.const_46,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_88),null,0) as IRegionWindow;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowMouseEvent.const_53,this.onCloseButtonMouseUp);
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_615:
               this.var_71.blend += param1 / const_984;
               this._window.blend += param1 / const_984;
               ...
               break;
            case const_992:
               this.var_71.blend -= param1 / const_985;
               this._window.blend -= param1 / const_985;
      ...
      public function set state(param1:int) : void
      {
         ...
         {
            case const_390:
               if(this._state == const_241)
               {
                  this.state = const_615;
               }
               else
               {
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_42.width - this.var_2201;
         }
         if(this.var_71 != null)
         {
            this.var_71.rectangle = this.var_42.rectangle;
            this.var_71.height -= const_88;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2200 == this._window.width)
         {
            return;
         }
         this.var_2200 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2199;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1654;
            barX.disposesBitmap = false;
            this.var_2201 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2202,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1655,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1655,destGripRBitmap);
         ...
         this.var_71.bitmap = this.var_2197;
