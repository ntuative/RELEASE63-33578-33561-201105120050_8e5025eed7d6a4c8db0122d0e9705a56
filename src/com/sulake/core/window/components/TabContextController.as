package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1443:String = "_SELECTOR";
      ...
      protected var var_2154:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1081 = findChildByTag(const_1443) as ITabSelectorWindow;
            if(this.var_1081 != null)
            {
      ...
      {
         if(this.var_2154 == null)
         {
            this.var_2154 = findChildByTag(const_1444) as IWindowContainer;
         }
      ...
      {
         return !!this.var_713 ? this.selector.iterator : null;
      }
