package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_472:IRoomSettingsCtrlOwner;
      ...
      private var var_1050:TextFieldManager;
      ...
      private var var_687:ICheckBoxWindow;
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_2046 = true;
         this.var_472.roomSettingsRefreshNeeded();
      }
      ...
      {
         if(param1 != this.var_397 || this.var_1300 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1300 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1778)
         {
            this.var_842.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1837)
         {
            this.var_842.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1769)
         {
            this.var_1297.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1734)
         {
            this.setTagError(this.var_984,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_985,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1745)
         {
            this.setTagError(this.var_984,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_985,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1714)
         {
            this.var_1050.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_328,this.onDoorModePasswordSelect);
         ...
         this.var_1297 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_984 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_985 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1050 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1293 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1295 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1294 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1299 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_687 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this._thumbnailContainer = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1296 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1301 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_2045 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1579 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_275 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1298 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1580 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1580.mouseThreshold = 0;
         this.var_1580.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1298.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_2045.visible = this._inRoom;
         if(this.var_843)
         {
         ...
         else
         {
            ...
            this.var_1296.height = Util.getLowestPoint(this.var_1296) + 4;
         }
         this.var_1580.text = !!this.var_843 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this._thumbnailContainer.name,this.var_1296.name,this.var_1301.name,this.var_1579.name,this.var_2045.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1297.setText(_loc1_.description);
         this.var_1050.setText("");
         this.var_1293.setText("");
         ...
         switch(_loc1_.doorMode)
         {
            case RoomSettingsData.const_208:
               ...
               break;
            case RoomSettingsData.const_132:
         ...
         this.changePasswordField(_loc1_.doorMode == RoomSettingsData.const_132);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         this.setCategorySelection(_loc1_.categoryId);
         this.refreshMaxVisitors(_loc1_);
         this.setTag(this.var_984,_loc1_.tags[0]);
         this.setTag(this.var_985,_loc1_.tags[1]);
         if(this.var_1295)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_1294)
         {
            ...
            {
               this.var_1294.select();
            }
            else
            {
               this.var_1294.unselect();
            }
         }
         if(this.var_1299)
         {
         ...
         if(this.var_687)
         {
            ...
            {
               this.var_687.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_687.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = this.var_1297.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_132;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_565;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_132)
         {
            _loc8_ = this.var_1050.getText();
            _loc9_ = this.var_1293.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1050.clearErrors();
         ...
         _loc2_.allowPets = this.var_1295.isSelected;
         _loc2_.allowFoodConsume = this.var_1294.isSelected;
         _loc2_.allowWalkThrough = this.var_1299.isSelected;
         _loc2_.hideWalls = this.var_687.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_984,_loc2_.tags);
         this.addTag(this.var_985,_loc2_.tags);
         this.clearErrors();
         this.var_1300 = _loc2_.roomId;
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_275.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_275.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_275.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_275.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_275.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_275.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_275.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_275);
         this.var_275.findChildByName("ruler").visible = true;
         ...
         if(this.var_77.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_275,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_79,HabboWindowStyle.const_30,HabboWindowParam.const_65,new Rectangle(0,0,100,20)));
      }
