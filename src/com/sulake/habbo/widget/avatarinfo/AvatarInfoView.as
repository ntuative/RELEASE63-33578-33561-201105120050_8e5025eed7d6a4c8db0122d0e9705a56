package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarInfoView
   {
      ...
      private static const const_1420:int = 25;
      ...
      protected var var_1612:int;
      
      protected var var_2144:Boolean;
      
      protected var var_2191:int;
      
      protected var var_1343:Boolean;
      
      protected var var_2142:FixedSizeStack;
      
      protected var var_2143:int = -1000000;
      
      public function AvatarInfoView(param1:AvatarInfoWidget)
      {
         this.var_2142 = new FixedSizeStack(const_1420);
         super();
         this._widget = param1;
      }
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_1612 = param5;
         param1.var_2191 = param4;
         param1.var_2144 = param6;
         param1.updateWindow();
      }
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_849));
      ...
      public function update(param1:Rectangle, param2:Point, param3:Number) : void
      {
         ...
         if(!this.var_1343)
         {
            ...
            if(this.var_1612 == RoomObjectTypeEnum.const_164 || this.var_1612 == RoomObjectTypeEnum.const_587)
            {
            ...
            this.var_2142.addValue(_loc5_);
            _loc6_ = this.var_2142.getMax();
            if(_loc6_ < this.var_2143 - const_1014)
            {
               _loc6_ = this.var_2143 - const_1014;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2143 = _loc6_;
