package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_439:String = "_DROPMENU_TITLETEXT";
      ...
      {
         if(param1 > this.var_269.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowEvent = WindowEvent.allocate(WindowEvent.const_328,this,null,true);
      ...
      {
         return getChildByName(DropMenuController.const_439) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_190 == null || this.var_190.disposed)
         {
            this.var_190 = context.create(name + "::submenu","",WindowType.const_554,var_79,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_269.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_1035 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_1035)
         {
            if(this.open())
            {
               if(this.var_269.length)
               {
                  this.populateMenuItemContainer(this.var_269,this.getSubMenu(),this.subMenuEventProc);
                  this.var_1035 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_1035 = false;
            this.getTitleLabel().text = this.var_682 < this.var_269.length && this.var_682 > -1 ? this.var_269[this.var_682] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_429,var_79,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_682 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_682).setStateFlag(WindowState.const_54,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_45 || param1.type == WindowTouchEvent.const_772)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1218:
            case WindowMouseEvent.const_53:
               ...
               break;
            case WindowTouchEvent.const_774:
      ...
      public function open() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1853,this,null);
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_269[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_269.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_838,this.var_269,PropertyStruct.const_155,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_838)
            {
