package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_872:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_339 = new Array();
            var_339[0] = MouseCursorType.const_313;
            var_339[1] = MouseCursorType.const_30;
            var_339[2] = MouseCursorType.const_313;
            var_339[3] = MouseCursorType.const_313;
            var_339[4] = MouseCursorType.const_313;
            var_339[5] = MouseCursorType.const_30;
            var_339[6] = MouseCursorType.const_313;
         }
         if(var_288 == null)
         {
            var_288 = new Array();
            var_288[0] = WindowState.const_87;
            var_288[1] = WindowState.const_86;
            var_288[2] = WindowState.const_84;
            var_288[3] = WindowState.const_72;
            var_288[4] = WindowState.const_54;
            var_288[5] = WindowState.const_90;
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_220;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_61 = state.var_1329 as WindowController;
         this.var_173 = state.var_1330 as WindowController;
         this.var_162 = state.renderer;
         this.var_872 = state.var_1326;
         eventQueue.begin();
         this.var_703.x = -1;
         this.var_703.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_703.x || event.stageY != this.var_703.y)
            {
               this.var_703.x = event.stageX;
               this.var_703.y = event.stageY;
               array = new Array();
               this.var_82.groupParameterFilteredChildrenUnderPoint(this.var_703,array,WindowParam.const_31);
            }
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_61 && !this.var_61.disposed)
                     {
                        ...
                        {
                           this.var_872.mouseEventReceived(event.type,this.var_61);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1329 = this.var_61;
         state.var_1330 = this.var_173;
         state.renderer = this.var_162;
         state.var_1326 = this.var_872;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_595))
         {
