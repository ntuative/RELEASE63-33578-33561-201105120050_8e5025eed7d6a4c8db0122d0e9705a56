package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1546:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1547:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1310:AvatarEditorHandler;
      ...
      private var var_1057:IFigureData;
      ...
      private var var_1589:IHabboAvatarEditorDataSaver = null;
      ...
      {
         this.var_936 = FigureData.const_80;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_196)
         {
            ...
            this.var_691["null"] = new FigureData(this);
            this.var_691["null"] = new FigureData(this);
            _loc2_ = this.var_691["null"];
            _loc3_ = this.var_691["null"];
            _loc2_.loadAvatarData(const_1546,FigureData.const_80);
            _loc3_.loadAvatarData(const_1547,FigureData.FEMALE);
            this.var_102 = new Map();
            this.var_557 = new Map();
            this.var_102.add(AvatarEditorFigureCategory.const_916,new BodyModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_263,new TorsoModel(this));
            this.var_102.add(AvatarEditorFigureCategory.const_970,new LegsModel(this));
            if(param1 == null || param1.indexOf(AvatarEditorFigureCategory.HOTLOOKS) > -1)
            {
               this.var_102.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
            }
            this.var_557.add(AvatarEditorSideCategory.const_112,new WardrobeModel(this));
            this.var_557.add(AvatarEditorSideCategory.const_608,new ClubPromoModel(this));
            this.var_196 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_691[param2];
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(this.var_102)
         {
            for each(_loc5_ in this.var_102)
            {
               _loc5_.reset();
            }
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1057.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1057.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_278 == null)
            {
               this.var_278 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_79,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_916);
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = this.var_102.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:ISideContentModel = this.var_557.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_556 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_1057 = this.var_556.getFigureData(AvatarType.const_128);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1310 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_691[this.var_936];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1589 != null)
         {
            ...
            this.var_1589.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_2061;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1311 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1548)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1608.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_556.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_556.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1328.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1574)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1311 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1328.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1311 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_557.getValue(AvatarEditorSideCategory.const_112);
      }
