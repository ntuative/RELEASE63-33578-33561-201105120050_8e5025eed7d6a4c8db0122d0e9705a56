package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1357:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1997:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1997 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_16.position = const_1357;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_926 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_270 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1997.prepare(this.var_926);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1311,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1225,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_675,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_912,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_675,false);
         ...
         this.var_1550 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1550.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1999 == -1 ? 0 : int(this.var_16.height - this.var_1999);
         var _loc4_:int = this.var_1998 == -1 ? 0 : int(this.var_16.width - this.var_1998);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_270.y = Util.getLowestPoint(this.var_16.content);
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1142,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_675,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1311,false);
         ...
         this.var_1999 = this.var_16.height;
         this.var_1998 = this.var_16.width;
