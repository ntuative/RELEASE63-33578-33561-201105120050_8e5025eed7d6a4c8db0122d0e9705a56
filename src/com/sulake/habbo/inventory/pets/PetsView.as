package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      {
         var _loc2_:PetsGridItem = this.var_555.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(this.var_555 == null || this.var_555.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_555.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_555.getValue(param1.id) != null)
         {
            return;
         }
         var _loc2_:PetsGridItem = new PetsGridItem(this,param1,this._windowManager,this._assetLibrary,this._avatarRenderer,this.var_66.isUnseen(param1.id));
         if(_loc2_ != null)
         {
            this.var_247.addGridItem(_loc2_.window);
            this.var_555.add(param1.id,_loc2_);
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_59)
         {
            ...
            {
               case "tab_floor":
                  this.var_66.switchToFurnitureCategory(FurniModel.const_40);
                  break;
               case "tab_wall":
                  this.var_66.switchToFurnitureCategory(FurniModel.const_48);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function updateState() : void
      {
         ...
         if(!this.var_66.isListInitialized())
         {
