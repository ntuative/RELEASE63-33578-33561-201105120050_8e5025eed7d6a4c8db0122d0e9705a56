package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1077:int = 60;
      
      private static const const_1076:int = 3600;
      
      private static const const_1078:int = 86400;
      
      private static const const_1079:int = 31536000;
      ...
      {
         if(param1 < 2 * const_1077)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1076)
         {
            return Math.round(param1 / const_1077) + " mins ago";
         }
         if(param1 < 2 * const_1078)
         {
            return Math.round(param1 / const_1076) + " hours ago";
         }
         if(param1 < 2 * const_1079)
         {
            return Math.round(param1 / const_1078) + " days ago";
         }
         return Math.round(param1 / const_1079) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1321.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_33.getXmlWindow("user_info"));
            this.var_1321.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_33,WindowTracker.const_1107,this._data.userId),this._callerFrame,this.var_1322,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new RoomVisitsCtrl(this.var_33,this._data.userId),this._callerFrame,this.var_1322,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new SendMsgsCtrl(this.var_33,this._data.userId,this._data.userName,this.var_1559),this._callerFrame,this.var_1322,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ModActionCtrl(this.var_33,this._data.userId,this._data.userName,this.var_1559),this._callerFrame,this.var_1322,false,true);
      }
