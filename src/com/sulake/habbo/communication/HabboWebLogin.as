package com.sulake.habbo.communication
{
   ...
   public class HabboWebLogin extends EventDispatcher implements IHabboWebLogin
   {
      ...
      public function HabboWebLogin(param1:String, param2:String, param3:String, param4:IEventDispatcher = null)
      {
         ...
         this.var_2795 = "https://" + param3 + "/security_check";
         this.var_2796 = "https://" + param3 + "/account/reauthenticate";
      }
      ...
      {
         var _loc1_:URLRequest = new URLRequest(this.var_2795);
         this.var_43 = new URLLoader();
      ...
      public function requestReAuthenticate() : void
      {
         ...
         var _loc2_:URLRequest = new URLRequest(this.var_2796);
         _loc2_.data = new URLVariables(_loc1_);
         _loc2_.method = URLRequestMethod.POST;
         this.var_43 = new URLLoader();
      ...
      {
         param1.addEventListener(SecurityErrorEvent.SECURITY_ERROR,this.method_6);
      ...
      {
         param1.removeEventListener(SecurityErrorEvent.SECURITY_ERROR,this.method_6);
      ...
      private function method_6(param1:SecurityErrorEvent) : void
      {
