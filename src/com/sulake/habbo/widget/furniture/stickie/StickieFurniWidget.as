package com.sulake.habbo.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1401:int = 14;
      
      private static const const_1403:int = 500;
      
      private static const const_1413:Number = 100;
      
      private static const const_1412:Number = 100;
      ...
      protected var var_2148:String = "stickieui_container";
      ...
      protected function showInterface() : void
      {
         ...
         {
            this._window = windowManager.createWindow(this.var_2148,"",HabboWindowType.const_79,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1413,const_1412,2,2),null,0) as IWindowContainer;
      ...
      protected function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_501,this.var_195,this._text,this.var_336);
      ...
      protected function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_501,this.var_195,this._text,this.var_336);
      ...
      protected function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_799,this.var_195);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1403;
         if(_loc2_.numLines < const_1401)
         {
            return;
         }
