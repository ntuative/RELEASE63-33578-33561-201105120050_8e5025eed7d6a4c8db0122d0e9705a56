package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         this.var_299 = param1;
         if(this.var_299 < int.MAX_VALUE && !this._target.disposed && this._target.width > this.var_299)
         {
      ...
      {
         return this.var_300 == int.MIN_VALUE && this.var_299 == int.MAX_VALUE && this.var_298 == int.MIN_VALUE && this.var_297 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            else if(this._target.width > this.var_299)
            {
               this._target.width = this.var_299;
            }
