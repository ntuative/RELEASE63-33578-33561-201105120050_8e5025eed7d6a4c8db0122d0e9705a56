package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_532,RoomObjectFurnitureActionEvent.const_573,RoomObjectFurnitureActionEvent.const_462,RoomObjectFurnitureActionEvent.const_538,RoomObjectWidgetRequestEvent.const_162];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_250,RoomWidgetInfostandExtraParamEnum.const_550);
            ...
            if(_loc4_ != this.var_2274)
            {
               this.var_2274 = _loc4_;
               if(_loc4_ == 1)
               {
