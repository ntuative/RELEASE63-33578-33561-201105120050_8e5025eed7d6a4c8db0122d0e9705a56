package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeUI implements INameChangeUI
   {
      ...
      {
         this.var_177.sendMessage(new ChangeUserNameMessageComposer(param1));
      }
      
      public function checkName(param1:String) : void
      {
         this.var_177.sendMessage(new CheckUserNameMessageComposer(param1));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         this.var_177.localization.registerParameter("help.tutorial.name.changed","name",name);
         this.var_177.windowManager.alert("${generic.notice}","${help.tutorial.name.changed}",0,function(param1:IAlertDialog, param2:WindowEvent):void
         {
            param1.dispose();
         });
      }
      ...
      {
         if(this.var_177 == null || this.var_177.assets == null)
         {
            return null;
         }
         var _loc3_:XmlAsset = XmlAsset(this.var_177.assets.getAssetByName(param1 + "_xml"));
         if(_loc3_ == null || this.var_177.windowManager == null)
         {
            return null;
         }
         return this.var_177.windowManager.buildFromXML(XML(_loc3_.content),param2);
      }
   }
}
