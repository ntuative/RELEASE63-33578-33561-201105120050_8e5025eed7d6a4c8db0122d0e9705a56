package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_1265:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.addEventListener(WindowEvent.const_43,this.onResized);
         }
         ...
         this.var_546 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
         this.var_1265 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
         ...
         {
            this.var_1265.load(_loc4_,this.var_169.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_65,WindowTracker.const_1179,_loc2_),this._window,false,false,true);
      }
