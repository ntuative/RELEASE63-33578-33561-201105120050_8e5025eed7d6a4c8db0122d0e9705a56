package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1400:int = 2;
      
      private static const const_1399:int = 1;
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            this.var_741[0] = this.getNewPoint(param1,0);
         }
         _loc2_ = getSprite(3);
         if(_loc2_ != null)
         {
            this.var_741[1] = this.getNewPoint(param1,1);
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            if(this.var_741.length == 2)
            {
               return this.var_741[param3 - 2].x;
            }
         }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         if(param3 == 2 || param3 == 3)
         {
            if(this.var_741.length == 2)
            {
               return this.var_741[param3 - 2].y;
            }
         }
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1145[param2];
         var _loc4_:int = this.var_1144[param2];
         var _loc5_:int = this.var_1146[param2];
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1145.push(Math.random() * _loc2_ * 1.5);
         this.var_1145.push(Math.random() * _loc2_ * 1.5);
         this.var_1144 = new Array();
         this.var_1144.push(1);
         this.var_1144.push(-1);
         this.var_1146 = new Array();
         this.var_1146.push(const_1400);
         this.var_1146.push(const_1399);
