package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_530:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_653:String = "{";
      
      private static const const_654:String = "}";
      
      private static const const_1440:String = "/*";
      
      private static const const_1439:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_86[const_209],var_86[ITALIC],var_86[BOLD]];
            var_86.reset();
            var_86[const_209] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_530.indexOf(_loc4_.name) == -1)
            {
               var_530.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "RoomWidgetInfostandExtraParamEnum" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_654);
         if(countSubStrings(param1,const_653) != countSubStrings(param1,const_654))
         {
            throw new Error("Mismatching amount of \"" + const_653 + "\" versus \"" + const_654 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1440) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1439) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_653)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
