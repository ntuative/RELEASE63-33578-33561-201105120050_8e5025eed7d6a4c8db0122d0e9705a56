package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_440:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_1961:uint = 1;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1333 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1333);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1402 & const_1313)
         {
            if(_loc3_ == 0)
            {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_1036 = false;
            this._events.dispatchEvent(new LockEvent(const_440,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_737 + "]";
      }
