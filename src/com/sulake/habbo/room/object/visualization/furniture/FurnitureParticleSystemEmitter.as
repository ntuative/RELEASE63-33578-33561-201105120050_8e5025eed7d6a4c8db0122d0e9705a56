package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1600:String = "cone";
      
      public static const const_1654:String = "plane";
      
      public static const const_1572:String = "sphere";
      ...
      public function reset() : void
      {
         ...
         this.var_965 = 0;
         this.var_1017 = false;
         this.init(0,0,0,this._direction,this.var_2548,this.var_964,this.var_2550,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1190.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_1017 = true;
         if(this.var_965 < this.var_1474)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2547)
         {
            switch(this.var_2546)
            {
               case const_1600:
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1190.length);
         return this.var_1190[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_965 < this.var_1474)
         {
            if(this.age % this.var_2549 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_965 < this.var_1474)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_258) * this.x - (1 - this.var_258) * this.lastX;
            this.y = (2 - this.var_258) * this.y - (1 - this.var_258) * this.lastY + this.var_1855 * this.var_964 * this.var_964;
            this.z = (2 - this.var_258) * this.z - (1 - this.var_258) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         ...
         for each(_loc2_ in this.var_369)
         {
            ...
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_258) * _loc2_.x - (1 - this.var_258) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_258) * _loc2_.y - (1 - this.var_258) * _loc2_.lastY + this.var_1855 * this.var_964 * this.var_964;
            _loc2_.z = (2 - this.var_258) * _loc2_.z - (1 - this.var_258) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
