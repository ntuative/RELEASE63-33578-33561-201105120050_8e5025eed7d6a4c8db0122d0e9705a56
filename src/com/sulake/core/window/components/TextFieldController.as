package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_713:Boolean = false;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1177,var_11);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_713 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         if(!_loc2_ && !param1)
         {
            _loc3_ = WindowEvent.allocate(WindowEvent.const_43,this,null);
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_392,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_842,false,PropertyStruct.const_39,true) : PropertyDefaults.const_1840);
         _loc1_.push(this.var_1342 != PropertyDefaults.const_1230 ? new PropertyStruct(PropertyDefaults.const_771,this.var_1342,PropertyStruct.const_39,true) : PropertyDefaults.const_1758);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1258 ? new PropertyStruct(PropertyDefaults.const_701,_field.selectable,PropertyStruct.const_39,true) : PropertyDefaults.const_1798);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1135 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true) : PropertyDefaults.const_1812);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_771:
                  this.var_1342 = _loc2_.value as Boolean;
                  if(this.var_1342)
                  {
               ...
               case PropertyDefaults.const_842:
                  ...
                  break;
               case PropertyDefaults.const_1095:
