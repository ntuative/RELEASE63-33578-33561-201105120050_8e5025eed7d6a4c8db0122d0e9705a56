package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1123:String = "issue_bundle_open";
      
      public static const const_978:String = "issue_bundle_my";
      
      public static const const_1132:String = "issue_bundle_picked";
      ...
      private var var_686:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_686 = new IssueBrowser(this,this.var_65.windowManager,this.var_65.assets);
         this.var_1292 = [];
         this.var_1291 = [];
         this.var_1047 = new Map();
         this.var_2808 = parseInt(this.var_65.configuration.getKey("chf.score.updatefactor","60"));
         this.var_2042 = new Timer(const_1575,0);
         this.var_2042.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_2042.start();
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_686 == null || !this.var_686.isOpen())
         {
            this.var_65.soundManager.playSound(HabboSoundTypesEnum.const_1157);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_1048.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_1048.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1760)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_107)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_1048.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2809++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_1048.add(param1.issueId,_loc2_);
         ...
         if(this.var_1292.indexOf(param1.issueId) != -1)
         {
            ...
            {
               if(param1.state == IssueMessageData.const_421)
               {
         ...
         {
            _loc6_ = this.getBundles(const_978);
            _loc7_ = false;
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2808);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_1047.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_1047.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_1048.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_107.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_1047.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_1047.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_421 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_1047.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
