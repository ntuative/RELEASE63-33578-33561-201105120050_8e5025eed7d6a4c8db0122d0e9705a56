package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2175:String = "my_issues";
      
      private const const_2176:String = "open_issues";
      
      private const const_2177:String = "picked_issues";
      
      private const const_2211:String = "closed_issues";
      ...
      private var var_1726:IIssueBrowserView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_342.view.width = this.var_242.container.width;
         this.var_342.view.height = this.var_242.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2175:
               if(this.var_1726 == null)
               {
                  this.var_1726 = new MyIssuesView(this.issueManager,this,this.var_242.container);
               }
               return this.var_1726;
            case this.const_2176:
               if(this.var_1725 == null)
               {
                  this.var_1725 = new OpenIssuesView(this.issueManager,this,this.var_242.container);
               }
               return this.var_1725;
            case this.const_2177:
               if(this.var_1724 == null)
               {
                  this.var_1724 = new PickedIssuesView(this.issueManager,this,this.var_242.container);
               }
