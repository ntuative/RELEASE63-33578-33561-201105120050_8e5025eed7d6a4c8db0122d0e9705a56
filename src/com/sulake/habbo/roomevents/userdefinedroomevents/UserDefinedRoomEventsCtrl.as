package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1532:int = 2;
      ...
      private var var_1955:TriggerConfs;
      
      private var var_1956:ActionTypes;
      
      private var var_1954:ConditionTypes;
      
      private var var_266:Dictionary;
      
      private var var_36:Triggerable;
      
      private var var_811:RoomObjectHightLighter;
      
      private var var_177:UserDefinedRoomEventsHelp;
      
      private var var_1237:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1955 = new TriggerConfs();
         this.var_1956 = new ActionTypes();
         this.var_1954 = new ConditionTypes();
         this.var_266 = new Dictionary();
         super();
         this.var_80 = param1;
         this.var_811 = new RoomObjectHightLighter(param1);
         this.var_177 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1237 = new SliderWindowController(this.var_80,IWindowContainer(this.find(this.var_50,"delay_slider_container")),this.var_80.assets,0,20,1);
         this.var_1237.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1237.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_811.hideAll(this.var_266);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_811.showAll(this.var_266);
         if(this.var_36 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_36);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1237.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1237.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_177.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1532) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1532 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1955);
         this.refreshConfigureElement(this.var_1956);
         this.refreshConfigureElement(this.var_1954);
