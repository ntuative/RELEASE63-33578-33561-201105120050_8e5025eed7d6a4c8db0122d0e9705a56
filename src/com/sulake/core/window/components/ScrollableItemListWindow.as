package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_439:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_439)
         {
            this.var_439.removeEventListener(WindowEvent.const_244,this.scrollBarEventProc);
            this.var_439.removeEventListener(WindowEvent.const_293,this.scrollBarEventProc);
            this.var_439 = null;
         }
         if(this.var_1184)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_439)
         {
            this.var_439 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_439)
            {
               this.var_439.addEventListener(WindowEvent.const_244,this.scrollBarEventProc);
               this.var_439.addEventListener(WindowEvent.const_293,this.scrollBarEventProc);
            }
         }
         return this.var_439;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_293)
         {
            this.hideScrollBar();
         }
      }
