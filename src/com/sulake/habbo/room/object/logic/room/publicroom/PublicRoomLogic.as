package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_196,RoomObjectRoomAdEvent.const_345,RoomObjectRoomAdEvent.const_321];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_412,"");
         _loc2_.setString(RoomObjectVariableEnum.const_897,"");
      ...
      {
         super.update(param1);
         if(this.var_1533 > 0 && param1 > this.var_1533)
         {
            this.adDelayTimeout();
            this.var_1533 = 0;
         }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1090:
                  _loc2_.setString(RoomObjectVariableEnum.const_412,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_897,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_626,Number(true));
                  this.var_1533 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1253);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_612)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_897);
                  if(_loc7_ != null && _loc7_.indexOf("http") == 0)
                  {
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_196,_loc5_,_loc6_,_loc7_));
