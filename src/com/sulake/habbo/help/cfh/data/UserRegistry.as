package com.sulake.habbo.help.cfh.data
{
   ...
   public class UserRegistry
   {
      ...
      private static const const_1442:int = 80;
      ...
      {
         var _loc1_:int = 0;
         while(this.var_532.length > const_1442)
         {
      ...
      {
         var _loc1_:* = null;
         while(this.var_1494.length > 0)
         {
            _loc1_ = this.var_532.getValue(this.var_1494.shift());
            if(_loc1_ != null)
            {
