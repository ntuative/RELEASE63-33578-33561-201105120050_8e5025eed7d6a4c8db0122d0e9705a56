package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1879:String = "ctlg_";
       
      
      protected var var_2141:XML;
      ...
      private var var_504:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1134:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_504 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1133);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1133);
      }
      ...
      {
         var _loc2_:String = const_1879 + param1;
         ...
         this.var_2141 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2141) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1585:
               if(this.var_1134 == null)
               {
                  this.var_1134 = new ItemGridCatalogWidget(param1);
                  this.var_35.push(this.var_1134);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1676:
               ...
               break;
            case CatalogWidgetEnum.const_1823:
            ...
            case CatalogWidgetEnum.const_1764:
               ...
               break;
            case CatalogWidgetEnum.const_1571:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_504.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_504 != null)
         {
            return this.var_504.dispatchEvent(param1);
         }
         return false;
      }
