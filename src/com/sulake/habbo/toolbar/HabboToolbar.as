package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1501:LogoutController;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","false") == "RoomWidgetInfostandExtraParamEnum")
         {
            this.var_1501 = new LogoutController(this,this._windowManager,this._assetLibrary,events,this._config);
         }
         if(this._view == null)
         {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_1175,this.onSetToolbarIconBitmapEvent);
         this.var_196 = true;
      }
      
      private function onSetToolbarIconBitmapEvent(param1:HabboToolbarSetIconEvent) : void
      {
         if(this._view != null && this.var_196)
         {
