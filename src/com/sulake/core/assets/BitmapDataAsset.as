package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_572:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_550 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_106 is BitmapDataAsset)
         {
            ...
            this.var_1530 = BitmapDataAsset(this.var_106).var_1530;
            this.var_1531 = BitmapDataAsset(this.var_106).var_1531;
            if(this._bitmap != null)
            {
               this.var_106 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1530 = _loc4_ == "1" || _loc4_ == "RoomWidgetInfostandExtraParamEnum";
                  break;
               case "flipV":
                  this.var_1531 = _loc4_ == "1" || _loc4_ == "RoomWidgetInfostandExtraParamEnum";
                  break;
            }
            _loc2_++;
         }
