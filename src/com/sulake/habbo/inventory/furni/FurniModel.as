package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_40:String = "S";
      
      public static const const_48:String = "I";
      
      public static const CATEGORY_PETS:String = "pets";
      
      private static const const_1336:int = 100;
      
      private static const const_1335:int = 1000;
      ...
      private var var_1629:Vector.<Array>;
      
      private var var_1630:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_574 = [];
         this.var_575 = [];
         this.var_573 = new Timer(const_1336,1);
         this.var_573.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2175 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_573.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_573.stop();
               this.var_573 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_40)
            {
               ...
               {
                  this.var_1629 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1629;
            }
            else
            {
               if(this.var_1630 == null)
               {
                  this.var_1630 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1630;
            }
         ...
         this._controller.setInventoryCategoryInit(InventoryCategory.const_70);
         ...
         if(this.getSelectedItemIndex(FurniModel.const_40) == -1)
         {
            this.toggleItemSelection(FurniModel.const_40,0);
         }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_879 == null)
         {
            this.var_879 = this._windowManager.buildFromXML(this.var_2175) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_879.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_40,const_48];
         var _loc5_:int = 0;
      ...
      {
         if(param1 == InventoryCategory.const_70 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_48:
                  ...
                  break;
               case CATEGORY_PETS:
                  this._controller.toggleInventoryPage(InventoryCategory.const_127);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_400);
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_40,const_48];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_40,const_48];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_576.add(const_40,new Array());
         this.var_576.add(const_48,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_40;
            _loc5_ = this.var_574.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_48;
            _loc5_ = this.var_575.indexOf(param1.ref) > -1;
         }
      ...
      {
         return getTimer() < this.var_2176 + const_1335;
      }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_335;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_326 || _loc3_.category == FurniCategory.const_359 || _loc3_.category == FurniCategory.const_337)
         {
            if(param1)
            {
               return false;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_335:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_576.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_971)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_574.indexOf(_loc2_) == -1)
            {
               this.var_574.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_575.indexOf(_loc2_) == -1)
            {
               this.var_575.push(_loc2_);
            }
         }
      }
      ...
      {
         return this.var_574.length + this.var_575.length;
      }
      ...
      public function resetUnseenItems() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(!this._view || !this._view.visibleCategoryId || !this.isMainViewActive())
         {
            return;
         }
         var _loc1_:IConnection = this._communication.getHabboMainConnection(null);
         ...
         {
            case const_48:
               if(this.var_575 && this.var_575.length > 0)
               {
                  _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1307));
                  this.var_575 = [];
                  _loc2_ = this.getCategoryContent(const_48);
               }
               break;
            case const_40:
               if(this.var_574 && this.var_574.length > 0)
               {
                  _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1326));
                  this.var_574 = [];
                  _loc2_ = this.getCategoryContent(const_40);
               }
         }
         if(_loc2_)
         {
            ...
            {
               _loc3_.hasUnseenItems = false;
               _loc3_.updateThumbData();
            }
         }
      }
   }
