package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_576:IFurnitureData;
      ...
      private function setOfferData(param1:IPurchasableOffer) : void
      {
         ...
         this.var_1989 = param1.productContainer.firstProduct.productClassId;
         this.var_1990 = param1.productContainer.firstProduct.productData;
         this.var_576 = param1.productContainer.firstProduct.furnitureData;
         this.var_1453 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_195,this._category,this.var_2050,this._x,this.var_159,this._direction,this._offerId,this.var_1989].toString();
      }
