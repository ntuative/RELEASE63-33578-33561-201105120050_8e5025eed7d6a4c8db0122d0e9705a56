package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_2038 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1284 = this.var_2038.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1284)
         {
            this.var_1284.procedure = this.onButtonClick;
         }
         this.var_1285 = this.var_2038.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1285)
         {
            this.var_1285.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_272 >= this.var_60.length - 1)
         {
            this.var_1285.disable();
         }
         else
         {
            this.var_1285.enable();
         }
         if(this.var_272 <= 0)
         {
            this.var_1284.disable();
         }
         else
         {
            this.var_1284.enable();
         }
      }
      ...
      {
         ++this.var_272;
         this.var_272 = Math.min(this.var_272,this.var_60.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_60[this.var_272][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_60[this.var_272][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_60[this.var_272][1]).value;
