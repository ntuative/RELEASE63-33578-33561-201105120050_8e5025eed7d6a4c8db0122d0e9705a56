package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         this.var_166["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_166["dance_icon"] = ["dance_white","dance_color"];
         this.var_166["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_166["effects_icon"] = ["effects_white","effects_color"];
         this.var_166["badges_icon"] = ["badges_white","badges_color"];
         this.var_166["wave_icon"] = ["wave_white","wave_color"];
         this.var_166["hc_icon"] = ["_white","_color"];
         this.var_166["settings_icon"] = ["settings_white","settings_color"];
         this.var_166["credits_icon"] = ["credits_white","credits_color"];
         this.var_166["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      {
         if(this.var_166[param1] == null)
         {
            return;
         }
         if(param3 != null)
         {
            this.var_166[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_166[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_166)
         {
            _loc6_ = this.var_166[_loc3_];
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1298);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1146));
            ...
            case "effects":
               ...
               this._widget.changeView(MeMenuWidget.const_691);
               break;
            case "rooms":
            ...
            case "badges":
               ...
               break;
            case "clothes":
               this._widget.changeView(MeMenuWidget.const_346);
               break;
            case "hc":
            ...
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = this._widget.config.getKey("client.credits.embed.enabled","false") == "RoomWidgetInfostandExtraParamEnum";
               if(false && _loc4_)
               {
