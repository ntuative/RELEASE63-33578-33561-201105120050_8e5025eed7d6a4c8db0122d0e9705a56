package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_134:IHabboMessenger;
      ...
      private var var_711:ISessionDataManager;
      
      private var var_2194:FriendListLookAndFeel;
      
      private var var_461:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1648:OpenedToWebPopup;
      
      private var var_2195:int;
      
      var var_102:FriendCategories;
      
      private var _friendRequests:FriendRequests;
      
      private var var_1647:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_1045:IHabboNotifications;
      
      private var var_579:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2194 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_102 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1647 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_579.stop();
            this.var_579.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_579 = null;
         }
         ...
         if(this.var_134)
         {
            this.var_134.release(new IIDHabboMessenger());
            this.var_134 = null;
         }
         if(this.var_175)
         {
         ...
         if(this.var_1096)
         {
            this.var_1096.release(new IIDAvatarRenderManager());
            this.var_1096 = null;
         }
         if(this.var_1045)
         {
            this.var_1045.release(new IIDHabboNotifications());
            this.var_1045 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_711)
         {
            this.var_711.release(new IIDSessionDataManager());
            this.var_711 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1648 = new OpenedToWebPopup(this);
         }
         this.var_1648.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_102.findFriend(param1);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_98);
      }
      
      public function openFriendSearch() : void
      {
         this.openFriendListWithTab(FriendListTab.const_306);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_102.getFriendCount(param1,param2);
      }
      
      public function refreshToolBarIcon() : void
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_382,HabboToolbarIconEnum.FRIENDLIST);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_331,HabboWindowStyle.const_46,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1096.createAvatarImage(param1,AvatarScaleType.const_95,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "RoomWidgetInfostandExtraParamEnum";
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_134 = param2 as IHabboMessenger;
      ...
      {
         this.var_1045 = param2 as IHabboNotifications;
      ...
      {
         this.var_711 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_102.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_102.addCategory(new FriendCategory(FriendCategory.const_1198,this.getText("friendlist.friends")));
         this.var_102.addCategory(new FriendCategory(FriendCategory.const_432,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_102.addFriend(new Friend(_loc4_));
         }
         this.var_461 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_579)
         {
            this.var_579 = new Timer(120000);
            this.var_579.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_579.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_710,HabboToolbarIconEnum.FRIENDLIST));
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_37,this.onHabboToolbarEvent);
         if(this.var_102.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_102.findCategory(FriendCategory.const_432);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_461.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_461.findTab(FriendListTab.const_98).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_461.findTab(FriendListTab.const_98);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1647.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_102.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_102.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_461.findTab(FriendListTab.const_98);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_711 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_711.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_711.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_44))
         {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(disposed || this.var_102 == null)
         {
            return;
         }
         var _loc2_:Dictionary = this.var_102.getAllFriends();
         if(_loc2_ == null)
         {
            return;
         }
