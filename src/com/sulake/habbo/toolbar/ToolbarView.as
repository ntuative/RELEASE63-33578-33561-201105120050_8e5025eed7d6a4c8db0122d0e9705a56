package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1357:Point = new Point(3,3);
      
      private static const const_1358:uint = 7433577;
      
      private static const const_1359:uint = 5723213;
      
      private static const const_442:String = "_hover";
      
      private static const const_443:String = "_normal";
      
      private static const const_988:int = 5;
      ...
      private var var_1367:BitmapData;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1357;
         ...
         {
            this.setIconHoverState(_loc11_,const_443);
         }
         ...
         param6.addEventListener(HabboToolbarEvent.const_303,this.onToolbarStateEvent);
         param6.addEventListener(HabboToolbarEvent.TOOLBAR_STATE_ROOM_VIEW,this.onToolbarStateEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this._events)
         {
            this._events.removeEventListener(HabboToolbarEvent.const_303,this.onToolbarStateEvent);
            this._events.removeEventListener(HabboToolbarEvent.TOOLBAR_STATE_ROOM_VIEW,this.onToolbarStateEvent);
            this._events = null;
         }
         if(this._catalog != null)
         {
      ...
      private function onToolbarStateEvent(param1:HabboToolbarEvent) : void
      {
         switch(param1.type)
         {
            case HabboToolbarEvent.const_303:
               this.iconVisibility("QUESTS",false);
               this.iconVisibility("MEMENU",false);
               this.iconVisibility("INVENTORY",false);
               break;
            case HabboToolbarEvent.TOOLBAR_STATE_ROOM_VIEW:
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               this.setIconHoverState(_loc4_,const_442);
               this.setIconBgHoverState(_loc3_,const_442);
               break;
            case WindowMouseEvent.const_25:
               this.setIconHoverState(_loc4_,const_443);
               this.setIconBgHoverState(_loc3_,const_443);
         }
      }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_442 ? this.var_1368 : this.var_1367;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_442)
         {
            param1.color = const_1358;
         }
         else
         {
            param1.color = const_1359;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1367 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1368)
         {
            this.var_1368.dispose();
         }
         this.var_1368 = this.addShadow(param1,new Point(4,5),4281150249);
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_894.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_988;
            _loc2_.y = const_988;
            this.var_894.add(param1,_loc2_);
         }
         return _loc2_;
      }
   }
