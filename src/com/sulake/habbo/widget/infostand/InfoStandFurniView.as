package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_240 = this.var_47.findChildByTag("catalog");
         if(this.var_240 != null)
         {
            this.var_240.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc5_.name)
         {
            ...
            case "save_branding_configuration":
               ...
               break;
            case "com.sulake.core.communication.handshake":
               _loc3_ = "null";
         }
         if(_loc3_ != null)
         {
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_688 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_550 && param1.isRoomOwner)
         {
         ...
         this.showButton("com.sulake.core.communication.handshake",_loc6_);
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1286.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_52.addListItem(this.var_240);
            }
            this.var_240.visible = param1;
         }
         else
         {
            this.var_52.removeListItem(this.var_240);
         }
      }
   }
}
