package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1015:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1422:String = "sendAccessTokenToServer";
      
      private static const const_1421:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1422,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1421,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1015);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1015);
         }
      }
