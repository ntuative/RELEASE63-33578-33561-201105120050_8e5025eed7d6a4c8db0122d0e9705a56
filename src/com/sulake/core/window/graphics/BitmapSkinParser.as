package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         var _loc6_:* = param2.attribute("transparent") == "RoomWidgetInfostandExtraParamEnum";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         _loc5_.colorize = _loc6_ == "" ? true : _loc6_ == "RoomWidgetInfostandExtraParamEnum";
         _loc6_ = null;
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_331 = SkinLayoutEntity.const_508;
                  break;
               case "move":
                  _loc5_.var_331 = SkinLayoutEntity.const_319;
                  break;
               case "strech":
                  _loc5_.var_331 = SkinLayoutEntity.const_570;
                  break;
               case "tiled":
                  _loc5_.var_331 = SkinLayoutEntity.const_323;
                  break;
               case "center":
                  _loc5_.var_331 = SkinLayoutEntity.const_497;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_330 = SkinLayoutEntity.const_508;
                  break;
               case "move":
                  _loc5_.var_330 = SkinLayoutEntity.const_319;
                  break;
               case "strech":
                  _loc5_.var_330 = SkinLayoutEntity.const_570;
                  break;
               case "tiled":
                  _loc5_.var_330 = SkinLayoutEntity.const_323;
                  break;
               case "center":
                  _loc5_.var_330 = SkinLayoutEntity.const_497;
            }
         }
