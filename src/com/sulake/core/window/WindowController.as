package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1333:String = "_COLORIZE";
      
      protected static const const_1332:String = "_IGNORE_INHERITED_STYLE";
      ...
      protected var var_704:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            ...
            var_476 = _loc13_.var_2906;
            if(var_477 != _loc13_.background)
            {
      ...
      {
         return this.var_704 != null ? this.var_704 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_477 = param1;
         var_238 = !!var_477 ? uint(var_238 | var_564) : uint(var_238 & 16777215);
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_238 = !!var_477 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      ...
      {
         var_564 = param1 << 24;
         var_238 = !!var_477 ? uint(var_564 | var_238) : uint(16777215 & var_238);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1295);
      }
      ...
      {
         var_476 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_885);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_79)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1332) == -1)
               {
                  _loc4_.style = var_79;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               _loc4_ = WindowEvent.allocate(WindowEvent.const_525,this,this._parent);
            ...
            else
            {
               ...
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1740,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_824,var_11);
            this.var_21.visible = var_316;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_79,var_20,_context,var_11,null,this.var_704,this.properties,var_871.concat(),_id) as WindowController;
         _loc2_.var_476 = var_476;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + _name + " " + this.var_2697 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1139,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_372,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_43,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
         }
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = 0;
         if(!testParamFlag(WindowParam.const_836))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_45:
                  ...
                  _loc4_.begin(this);
                  _loc4_.eventTypes.push(WindowMouseEvent.const_53);
                  _loc4_.areaLimit = MouseListenerType.const_1252;
                  if(testParamFlag(WindowParam.const_416))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_257))
                        {
               ...
               case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                  ...
                  break;
               case WindowMouseEvent.const_320:
                  return false;
            }
         }
            ...
            switch(param2.type)
            {
               case WindowEvent.const_43:
                  ...
                  if(param1 == this)
                  {
                     ...
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_217,WindowParam.const_179))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_211,WindowParam.const_175))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
               ...
               case WindowEvent.const_372:
                  ...
                  _context.invalidate(this,_loc6_,WindowRedrawFlag.const_1220);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1763,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_215,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
                  break;
               case WindowEvent.const_584:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1098,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_324,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_476);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_476);
      }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_79 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1332) == -1)
               {
                  _loc6_.style = var_79;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_158,WindowParam.const_179);
         var _loc2_:* = !testParamFlag(WindowParam.const_165,WindowParam.const_175);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_386)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_427)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               ...
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_350)
               {
               ...
               else if(_loc5_ == WindowParam.const_211)
               {
      ...
      {
         if(_state == WindowState.const_581)
         {
            return true;
         }
         _state = WindowState.const_581;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1873,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1608,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1641,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_584,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_72,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1628,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_72,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1702,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_973,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_858,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_293,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_627,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_627,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
