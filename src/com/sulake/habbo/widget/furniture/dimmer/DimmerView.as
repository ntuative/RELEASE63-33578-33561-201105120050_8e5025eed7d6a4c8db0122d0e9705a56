package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_79,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1413,const_1412,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1431 = _loc2_.light;
         if(this.var_431 != null)
         {
            this.var_431.setValue(this.var_1431);
         }
         this.var_553 = this.colors.indexOf(_loc2_.color);
         if(this.var_620 != null)
         {
            this.var_620.setSelectedColorIndex(this.var_553);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1430 = XML(_loc1_.content);
         return this.var_1430;
      }
