package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_2039:IAlertDialog;
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         this._questEngine.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_710,HabboToolbarIconEnum.QUESTS));
      }
      
      private function onRoomExit(param1:IMessageEvent) : void
      {
         this._questEngine.questController.onRoomExit();
         this._questEngine.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_436,HabboToolbarIconEnum.QUESTS));
      ...
      {
         return this._questEngine.configuration.getKey("standaloneAchievementList.enabled","false") == "RoomWidgetInfostandExtraParamEnum";
      }
   }
}
