package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1118:MeMenuSoundSettingsView;
      ...
      private var var_1204:Number = 1.0;
      ...
      public function set min(param1:Number) : void
      {
         ...
         this.setValue(this.var_1118.volume);
      }
      ...
      {
         return param1 / this.var_1700 * (this.var_1204 - this._minValue) + this._minValue;
      }
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1118.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_723 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_723.width,this.var_723.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_723,this.var_723.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_724 != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_724.width,this.var_724.height,true,16777215);
                  _loc3_.bitmap.copyPixels(this.var_724,this.var_724.rect,new Point(0,0),null,null,true);
                  _loc2_.procedure = this.buttonProcedure;
                  this.var_1700 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
