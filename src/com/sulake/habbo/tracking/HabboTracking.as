package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_996:uint = 11;
      ...
      private var var_1124:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_177:IHabboHelp;
      ...
      private var var_417:FramerateTracker = null;
      
      private var var_243:LatencyTracker = null;
      
      private var var_594:LagWarningLogger = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_417 = new FramerateTracker();
         this.var_243 = new LatencyTracker();
         this.var_594 = new LagWarningLogger();
         this.var_595 = new ToolbarClickTracker(this);
         this.var_1390 = new Array(const_996);
         var _loc4_:int = 0;
         while(_loc4_ < const_996)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1749,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1688,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1587,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_931,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1224,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1124)
            {
               this.var_1124.release(new IIDHabboWindowManager());
               this.var_1124 = null;
            }
            if(this.var_308)
            {
            ...
            if(this.var_202)
            {
               if(!this.var_202.disposed)
               {
                  ...
                  Component(this.var_202).events.removeEventListener(HabboFriendListTrackingEvent.const_407,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_177)
            {
               if(!this.var_177.disposed)
               {
                  this.var_177.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_177.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_177.release(new IIDHabboHelp());
               this.var_177 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_196,this.onRoomAdClick);
            ...
            {
               this.var_294.stop();
               this.var_294.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_294 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_175)
         {
            if(this.var_243 != null)
            {
               this.var_243.configuration = this.var_175;
            }
            if(this.var_244 != null)
            {
               this.var_244.configuration = this.var_175;
            }
            ...
            if(this.var_175)
            {
               ...
               {
                  this.var_594.configure(this.var_175);
               }
               if(this.var_417 != null)
               {
                  this.var_417.configure(this.var_175);
               }
               if(this.var_595 != null)
               {
                  this.var_595.configure(this.var_175);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_269,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_781,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_67,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_472,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_594 != null)
            {
               this.var_594.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_781)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1596);
         }
         else if(param1.type == HabboHotelViewEvent.const_472)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1573);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_743:
               this.trackLoginStep(HabboLoginTrackingStep.const_1803,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_213:
               ...
               break;
            case HabboCommunicationEvent.const_269:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_269);
               if(this.var_243 != null)
               {
                  this.var_243.init();
               }
      ...
      {
         this.var_1124 = IHabboWindowManager(param2);
         if(this.var_1124)
         {
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_202).events.addEventListener(HabboFriendListTrackingEvent.const_407,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_177 = param2 as IHabboHelp;
         this.var_177.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_177.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1224,String(_loc2_.guestRoomId));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_196,this.onRoomAdClick);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_308.events.addEventListener(AdEvent.const_469,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_349)
         {
            if(this.var_1734 < 1)
            {
               if(!this.var_294)
               {
                  this.var_294 = new Timer(60000,1);
                  this.var_294.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_294.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_325)
         {
            if(this.var_294)
            {
               this.var_294.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_417)
               {
                  ...
                  this.trackConversionPoint("Performance","fps",String(this.var_417.frameRate),_loc2_);
                  ++this.var_1734;
               }
            }
         }
      ...
      {
         this.var_594.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_496 > -1 && _loc2_ < this.var_496)
         {
            ++this.var_1733;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1733);
         }
         if(this.var_496 > -1 && _loc2_ - this.var_496 > 15000)
         {
            ++this.var_1732;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1732);
         }
         this.var_496 = _loc2_;
         if(this.var_244 != null)
         {
            this.var_244.update(param1,this.var_496);
         }
         if(this.var_243 != null)
         {
            this.var_243.update(param1,this.var_496);
         }
         if(this.var_417 != null)
         {
            this.var_417.trackUpdate(param1,this,this.var_496);
         }
         if(this.var_594 != null)
         {
            this.var_594.update(this.var_496);
         }
      }
   }
}
