package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MainWindowHandler
   {
      ...
      private static const const_1551:int = 6;
      
      private static const const_1550:int = 9;
      ...
      private var var_2066:IScrollbarWindow;
      
      private var var_2067:IScrollbarWindow;
      ...
      public function MainWindowHandler(param1:PlayListEditorWidget, param2:IHabboMusicController)
      {
         ...
         this._widget = param1;
         this.var_221 = param2;
         var _loc3_:Array = [PlayListEditorWidgetAssetsEnum.const_796,PlayListEditorWidgetAssetsEnum.const_694,PlayListEditorWidgetAssetsEnum.const_493,PlayListEditorWidgetAssetsEnum.const_562,PlayListEditorWidgetAssetsEnum.const_746];
      ...
      public function destroy() : void
      {
         if(this.var_221)
         {
            this.var_221.stop(HabboMusicPrioritiesEnum.const_397);
            this.var_221 = null;
         }
         if(this.var_558)
         {
      ...
      {
         this.var_221.requestUserSongDisks();
         var _loc1_:IPlayListController = this.var_221.getRoomItemPlaylist();
         if(_loc1_ != null)
         {
      ...
      public function refreshLoadableAsset(param1:String = "") : void
      {
         ...
         {
            this.assignWindowBitmapByAsset(this.var_1059,"music_inventory_splash_image",PlayListEditorWidgetAssetsEnum.const_796);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_694)
         {
            this.assignWindowBitmapByAsset(this.var_1058,"playlist_editor_splash_image",PlayListEditorWidgetAssetsEnum.const_694);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_493)
         {
            this.var_235.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_493));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_562)
         {
            this.var_235.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_562));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_746)
         {
            this.var_328.addSongsBackgroundImage = this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_746);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2066 = this.var_1059.getChildByName("music_inventory_scrollbar") as IScrollbarWindow;
         this.var_2067 = this.var_1058.getChildByName("playlist_scrollbar") as IScrollbarWindow;
      ...
      private function selectPlayListStatusViewByFurniPlayListState() : void
      {
         ...
         if(_loc1_.isPlaying)
         {
            this.var_328.selectView(PlayListStatusView.const_484);
         }
         else if(_loc1_.length > 0)
         {
            this.var_328.selectView(PlayListStatusView.const_1296);
         }
         else
         {
            this.var_328.selectView(PlayListStatusView.const_689);
         }
      }
      ...
      private function selectMusicStatusViewByMusicState() : void
      {
         ...
         {
            this.var_235.show();
            this.var_235.selectView(MusicInventoryStatusView.const_882);
         }
         else if(this.var_221.getSongDiskInventorySize() <= const_1551)
         {
            this.var_235.show();
            this.var_235.selectView(MusicInventoryStatusView.const_719);
         }
         else
         {
            this.var_235.hide();
      ...
      public function onSongDiskInventoryReceived() : void
      {
         ...
         this.var_2066.visible = this.var_558.itemCount > const_1550;
      }
      ...
      public function onNowPlayingChanged(param1:RoomWidgetPlayListEditorNowPlayingEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPlayListEditorNowPlayingEvent.const_101:
               ...
               if(param1.id != -1)
               {
                  _loc3_ = this.var_221.getSongInfo(param1.id);
            ...
            case RoomWidgetPlayListEditorNowPlayingEvent.const_126:
               ...
               this.selectMusicStatusViewByMusicState();
               break;
            case RoomWidgetPlayListEditorNowPlayingEvent.const_118:
      ...
      {
         return this.var_221.getSongIdPlayingAtPriority(HabboMusicPrioritiesEnum.const_397) != -1;
      }
   }
}
