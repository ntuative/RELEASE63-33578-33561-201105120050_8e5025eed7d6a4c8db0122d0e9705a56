package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_377.events.removeEventListener(BadgeImageReadyEvent.const_111,this.var_1066.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_377.events.addEventListener(BadgeImageReadyEvent.const_111,this.var_1066.onBadgeImageReady);
      }
      ...
      {
         return this.var_175.getKey("questing.enabled","false") == "RoomWidgetInfostandExtraParamEnum";
      }
