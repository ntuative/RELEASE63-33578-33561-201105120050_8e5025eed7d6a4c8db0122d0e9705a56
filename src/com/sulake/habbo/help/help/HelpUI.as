package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2076:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201105120045));
         this.var_126 = new Map();
         this.var_126.add(HabboHelpViewEnum.const_1578,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_126.add(HabboHelpViewEnum.const_212,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_126.add(HabboHelpViewEnum.const_620,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_126.add(HabboHelpViewEnum.const_338,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_126.add(HabboHelpViewEnum.const_265,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_126.add(HabboHelpViewEnum.const_411,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_126.add(HabboHelpViewEnum.const_733,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_126.add(HabboHelpViewEnum.const_270,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_126.add(HabboHelpViewEnum.const_1184,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_126.add(HabboHelpViewEnum.const_1143,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_126.add(HabboHelpViewEnum.const_972,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_126.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_126.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(param1 == this.var_2076)
         {
            this.var_560 = new Array();
         }
         else if(param2)
         {
            if(this.var_560.length == 0 || param1 != this.var_400)
            {
               this.var_560.push(this.var_400);
            }
         }
         this.var_400 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_270:
               this.showUI(HabboHelpViewEnum.const_270);
               break;
            case CallForHelpResultEnum.const_1281:
               this.showUI(HabboHelpViewEnum.const_1143);
               break;
            case CallForHelpResultEnum.const_1125:
               this.showUI(HabboHelpViewEnum.const_1184);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_126.getValue(HabboHelpViewEnum.const_212) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_515));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_126.length)
         {
            _loc3_ = this.var_126.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_126.getValue(this.var_400);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2647 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2645;
         this._window.width = _loc1_.width + this.var_2647;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_560.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_400 == HabboHelpViewEnum.const_212)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_400 == HabboHelpViewEnum.const_212 || this.var_560.length == 0)
         {
            return;
         }
         if(this.var_401 == null)
