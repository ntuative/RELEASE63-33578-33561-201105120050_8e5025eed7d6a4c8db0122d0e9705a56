package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      private var var_654:IItemGridWindow;
      ...
      public function destroy() : void
      {
         ...
         {
            this.var_654.destroyGridItems();
            this.var_654 = null;
         }
         if(this.var_221 != null)
         {
            if(this.var_221.events != null)
            {
      ...
      public function refresh() : void
      {
         ...
         this.var_654.removeGridItems();
         var _loc1_:Map = this._items;
         var _loc2_:Map = new Map();
         var _loc3_:Array = _loc1_.getKeys();
         this._items = new Map();
         var _loc4_:int = this.var_221.getSongDiskInventorySize();
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc7_ = this.var_221.getSongDiskInventoryDiskId(_loc5_);
            _loc8_ = this.var_221.getSongDiskInventorySongId(_loc5_);
            _loc9_ = this.var_221.getSongInfo(_loc8_);
            _loc10_ = null;
            _loc11_ = null;
            if(_loc9_ != null)
            {
            ...
            this.var_654.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         if(this.var_98 != null)
         {
            this.var_98.playButtonState = MusicInventoryGridItem.const_1097;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_98 != null)
         {
            this.var_98.playButtonState = MusicInventoryGridItem.const_611;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc3_:* = param1.type == WindowMouseEvent.const_136;
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_98.playButtonState == MusicInventoryGridItem.const_611)
               {
                  this.var_98.playButtonState = MusicInventoryGridItem.const_1215;
            ...
            {
               _loc4_ = this.var_654.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
