package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2202:int = 5;
      
      private const const_2201:int = 5;
      ...
      private var var_1254:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1253 = 0;
         this.var_1254 = param2.rectangle.clone();
         this.var_1254.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1254.width)
         {
            return false;
         }
         if(this.var_1253 + param1.height > this.var_1254.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1254.width)
         {
            this._offsetX = 0;
            this.var_1253 += param1.height + this.const_2201;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1253);
         this._offsetX += param1.width + this.const_2202;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1574 != null && this.var_1574.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_156);
