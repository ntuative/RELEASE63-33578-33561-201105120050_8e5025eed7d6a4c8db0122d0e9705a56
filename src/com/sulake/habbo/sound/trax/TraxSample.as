package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1849:String = "sample_44khz";
      
      public static const const_1586:String = "sample_22khz";
      
      public static const const_1866:String = "sample_11khz";
      
      public static const const_1592:String = "sample_16bit";
      
      public static const const_1868:String = "sample_8bit";
      
      public static const SAMPLE_VALUE_MULTIPLIER:Number = 0.000030517578125;
      
      private static const const_1013:int = 32;
      ...
      private static const const_186:int = 32767;
       
      
      private var _disposed:Boolean = false;
      
      private var var_115:Vector.<int> = null;
      
      private var _id:int;
      
      private var var_161:int = 2;
      
      private var var_74:int = 1;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_161 * this.var_74;
         var _loc7_:int = param1.length / 8;
         _loc7_ = int(_loc7_ / _loc6_) * _loc6_;
         this.var_115 = new Vector.<int>(_loc7_ / _loc6_,true);
         var _loc8_:Number = 1 / (Number(_loc5_) / 2);
         param1.position = 0;
         var _loc9_:int = 0;
         var _loc10_:int = _loc7_ / this.var_74;
         var _loc11_:int = 0;
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1013)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1013);
            }
            ...
            {
               this.var_115[int(_loc11_ / this.var_161)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_115.length * this.var_161 * this.var_74;
      }
      
      public function get usageCount() : int
      {
         return this.var_622.length;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:* = 0;
         if(param1 == null || this.var_115 == null)
         {
            return param4;
         }
         var _loc5_:int = this.var_161 * this.var_74;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
         ...
         var _loc7_:int = 0;
         if(_loc6_ > this.var_115.length - param4)
         {
            _loc7_ = (_loc6_ - (this.var_115.length - param4)) * _loc5_;
            _loc6_ = this.var_115.length - param4;
         ...
         if(this.var_74 == 1)
         {
            if(this.var_161 == 2)
            {
               while(_loc6_-- > 0)
               {
                  _loc8_ = this.var_115[param4++];
                  var _loc11_:*;
                  param1[_loc11_ = param2++] = (_loc8_ >> 16 & const_187) - const_186;
                  var _loc12_:*;
                  param1[_loc12_ = param2++] = (_loc8_ & const_187) - const_186;
               }
            }
         ...
         else if(this.var_74 >= 2)
         {
            ...
            if(this.var_161 == 2)
            {
               ...
               {
                  _loc8_ = this.var_115[param4++];
                  _loc10_ = int((_loc8_ >> 16 & const_187) - const_186);
                  _loc9_ = this.var_74;
                  while(_loc9_ > 0)
                  {
                  ...
                  _loc10_ = int((_loc8_ & const_187) - const_186);
                  _loc9_ = this.var_74;
                  while(_loc9_ > 0)
                  {
                     param1[_loc11_ = param2++] = _loc10_;
      ...
      public function addSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         if(this.var_74 == 1)
         {
            if(this.var_161 == 2)
            {
               while(_loc6_-- > 0)
               {
                  _loc7_ = this.var_115[param4++];
                  var _loc10_:*;
                  param1[_loc10_ = param2++] = param1[_loc10_] + ((_loc7_ >> 16 & const_187) - const_186);
                  var _loc11_:*;
                  param1[_loc11_ = param2++] = param1[_loc11_] + ((_loc7_ & const_187) - const_186);
               }
            }
            else if(this.var_161 == 4)
            {
         ...
         else if(this.var_74 >= 2)
         {
            ...
            if(this.var_161 == 2)
            {
               ...
               {
                  _loc7_ = this.var_115[param4++];
                  _loc9_ = int((_loc7_ >> 16 & const_187) - const_186);
                  _loc8_ = this.var_74;
                  while(_loc8_ > 0)
                  {
                  ...
                  _loc9_ = int((_loc7_ & const_187) - const_186);
                  _loc8_ = this.var_74;
                  while(_loc8_ > 0)
                  {
                     param1[_loc10_ = param2++] = param1[_loc10_] + _loc9_;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(this.var_622.indexOf(param1) == -1)
         {
            this.var_622.push(param1);
         }
      ...
      public function isUsedFromSong(param1:int) : Boolean
      {
         ...
         return this.var_622.indexOf(param1) != -1;
      }
   }
}
