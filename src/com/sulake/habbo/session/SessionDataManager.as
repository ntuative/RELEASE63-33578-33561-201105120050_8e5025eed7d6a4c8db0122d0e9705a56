package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1753:GroupDetailsView;
      ...
      private var var_1755:UserTagManager;
      
      private var var_1404:BadgeImageManager;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_607)
         {
            this.var_607.removeEventListener(ProductDataParser.const_117,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1404 = new BadgeImageManager(context.root.assets,events,this.var_175,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1755.communication = this._communication;
         this.var_1130.communication = this._communication;
         this.var_1129.communication = this._communication;
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_295)
         {
            ...
            this.var_295 = new FurnitureDataParser(this.var_502,this._wallItems,this.var_503,this._localization);
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2227 = _loc2_.clubLevel;
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2261 = _loc3_.respectTotal;
         this._respectLeft = _loc3_.respectLeft;
         this.var_735 = _loc3_.petRespectLeft;
         this.var_623 = _loc3_.figure;
         this.var_936 = _loc3_.sex;
         this.var_1659 = _loc3_.realName;
         this.var_2373 = _loc3_.identityId;
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            this.var_936 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_623,this.var_936));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2375 = _loc2_.isOpen;
         this.var_2374 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_1754 >= SecurityLevelEnum.const_1264;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1755.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1404.getBadgeImage(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1753 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1130.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1753.showGroupDetails(param1);
         }
      }
      ...
      {
         return this.var_1404.getBadgeImage(param1,BadgeImageManager.const_1191);
      }
      ...
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_735 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_735 = this.var_735 - 1;
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return this.var_502.getValue(param1.toString());
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_503.getValue(param1);
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(param1 && this.var_1128.indexOf(param1) == -1)
         {
            this.var_1128.push(param1);
         }
         if(!this.var_175)
         {
            return false;
         ...
         if(this.var_607 == null)
         {
            ...
            this.var_607 = new ProductDataParser(_loc2_,this.var_1117);
            this.var_607.addEventListener(ProductDataParser.const_117,this.onProductsReady);
         }
         return false;
      }
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         var _loc2_:Array = this.var_502.getValues();
