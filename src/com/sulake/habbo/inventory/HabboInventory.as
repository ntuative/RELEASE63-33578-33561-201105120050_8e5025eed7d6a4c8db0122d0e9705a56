   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_616,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_51.getValue(InventoryCategory.const_70));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_51.getValue(InventorySubCategory.const_335));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_51.getValue(InventoryCategory.const_850));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_51.getValue(InventoryCategory.const_348));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_51.getValue(InventorySubCategory.const_1244));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_51.getValue(InventoryCategory.const_127));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_51.getValue(InventoryCategory.const_400) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_616,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_94:
               this.var_1097 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_616:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      private function initInventory() : void
      {
         ...
         this.var_51.add(InventoryCategory.const_400,_loc1_);
         ...
         this.var_51.add(InventoryCategory.const_850,_loc4_);
         ...
         this.var_51.add(InventorySubCategory.const_335,_loc6_);
         ...
         this.var_51.add(InventorySubCategory.const_1244,_loc7_);
         ...
         this.var_51.add(InventoryCategory.const_127,_loc8_);
         this.var_196 = true;
         if(this.var_2880)
         {
            this.requestData();
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1069.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_1069.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1069.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1069.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_676));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2879)
         {
            this.var_2879 = _loc1_;
