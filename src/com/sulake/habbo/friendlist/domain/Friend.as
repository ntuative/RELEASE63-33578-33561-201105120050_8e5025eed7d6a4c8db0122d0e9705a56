package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2048:int = "F".charCodeAt(0);
      
      public static const const_2042:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_936 = param1.gender;
         this.var_845 = param1.online;
         this.var_1743 = param1.followingAllowed && param1.online;
         this.var_623 = param1.figure;
         this.var_1661 = param1.motto;
         this.var_1660 = param1.lastAccess;
         this.var_1432 = param1.categoryId;
         this.var_1659 = param1.realName;
