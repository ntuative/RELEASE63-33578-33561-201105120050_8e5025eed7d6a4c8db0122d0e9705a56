package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_1648:int = 0;
      ...
      private var var_1192:Vector3d = null;
      
      private var var_93:Vector3d = null;
      
      private var var_327:Vector3d = null;
      
      private var var_326:Vector3d = null;
      ...
      private var var_967:IPlaneRasterizer = null;
      ...
      private var var_775:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_326.assign(param4);
         this._normal = Vector3d.crossProduct(this.var_327,this.var_326);
         ...
         this.var_2566 = param11;
         this.var_2567 = param12;
         this.var_966 = param6;
      }
      
      public function set canBeVisible(param1:Boolean) : void
      {
         if(param1 != this.var_775)
         {
            if(!this.var_775)
            {
      ...
      {
         return this._isVisible && this.var_775;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_208 != null)
         {
            ...
            {
               _loc2_ = this.var_208.getWithIndex(_loc1_) as PlaneBitmapData;
               if(_loc2_ != null)
               {
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_652);
                  return param1;
               }
            }
         }
      ...
      {
         var _loc3_:PlaneBitmapData = this.var_208.remove(param1) as PlaneBitmapData;
         if(_loc3_ != null)
         {
         ...
         this.var_441 = param2;
         this.var_208.add(param1,param2);
         return true;
      }
      ...
      private function resetTextureCache(param1:BitmapData = null) : void
      {
         ...
         if(this.var_208 != null)
         {
            ...
            {
               _loc3_ = this.var_208.getWithIndex(_loc2_) as PlaneBitmapData;
               if(_loc3_ != null)
               {
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_967.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc3_ = this.var_208.getValue(_loc4_) as PlaneBitmapData;
         }
         this.updateMaskChangeStatus();
         if(this.var_775 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_370))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            _loc6_ = this.var_326.length * param1.scale;
            ...
            if(this.var_967 != null)
            {
               _loc3_ = this.var_967.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1864,this.var_2565,this.var_2564,this.var_2566,this.var_2567,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1861 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_775)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1358.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1358[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1192);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_164.z - originZ,this.var_119.z - originZ,this.var_85.z - originZ,this.var_120.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2563 = relativeDepth;
            this._isVisible = true;
            this.var_1861 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2568);
      ...
      {
         this.var_164.assign(param1.getScreenPosition(this.var_93));
         this.var_119.assign(param1.getScreenPosition(Vector3d.sum(this.var_93,this.var_326)));
         this.var_85.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_93,this.var_327),this.var_326)));
         this.var_120.assign(param1.getScreenPosition(Vector3d.sum(this.var_93,this.var_327)));
         this._offset = param1.getScreenPoint(this.var_1192);
         ...
         var _loc2_:Number = Math.min(this.var_164.x,this.var_119.x,this.var_85.x,this.var_120.x);
         var _loc3_:Number = Math.max(this.var_164.x,this.var_119.x,this.var_85.x,this.var_120.x);
         var _loc4_:Number = Math.min(this.var_164.y,this.var_119.y,this.var_85.y,this.var_120.y);
         var _loc5_:Number = Math.max(this.var_164.y,this.var_119.y,this.var_85.y,this.var_120.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_164 == null || this.var_119 == null || this.var_85 == null || this.var_120 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
         var _loc3_:Number = this.var_120.x - this.var_85.x;
         var _loc4_:Number = this.var_120.y - this.var_85.y;
         var _loc5_:Number = this.var_119.x - this.var_85.x;
         var _loc6_:Number = this.var_119.y - this.var_85.y;
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_966)
         {
            ...
            {
               _loc4_ = this.var_259[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_259.length == this.var_968.length)
         {
            while(_loc1_ < this.var_259.length)
            {
               _loc4_ = this.var_259[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
         ...
         if(this.var_371.length > this.var_1476.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_966 || this.var_259.length == 0 && this.var_371.length == 0 && !this.var_370 || this.var_762 == null)
         {
            return;
         }
         ...
         if(this.var_370)
         {
            ...
            while(_loc5_ < this.var_259.length)
            {
               _loc3_ = this.var_259[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_68.width - this.var_68.width * _loc3_.leftSideLoc / this.var_327.length;
                  _loc11_ = this.var_68.height - this.var_68.height * _loc3_.rightSideLoc / this.var_326.length;
                  _loc12_ = _loc3_.type;
                  this.var_762.updateMask(this.var_68,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_371.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_68.width - this.var_68.width * _loc4_.leftSideLoc / this.var_327.length;
                  _loc11_ = this.var_68.height - this.var_68.height * _loc4_.rightSideLoc / this.var_326.length;
                  _loc13_ = this.var_68.width * _loc4_.leftSideLength / this.var_327.length;
                  _loc14_ = this.var_68.height * _loc4_.rightSideLength / this.var_326.length;
                  this.var_68.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1476.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_370 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_224.copyChannel(param1,param1.rect,const_652,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_224.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_224,this.var_224.rect,const_652,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
