package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1110:String = "_EXCLUDE";
      
      public static const const_2044:String = "_INCLUDE";
      
      public static const const_2055:String = "_TEMP";
      
      private static const const_1478:String = "layout";
      
      private static const const_1052:String = "window";
      
      private static const const_1051:String = "variables";
      
      private static const const_1053:String = "filters";
      
      private static const const_452:String = "name";
      
      private static const const_1482:String = "style";
      
      private static const const_663:String = "params";
      
      private static const const_1489:String = "tags";
      ...
      private static const const_1487:String = "visible";
      
      private static const const_1488:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1295:String = "blend";
      
      private static const const_1483:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1484:String = "treshold";
      
      private static const const_1490:String = "children";
      
      private static const const_1480:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1491:String = "height_min";
      
      private static const const_1485:String = "height_max";
      
      private static const const_662:String = "RoomWidgetInfostandExtraParamEnum";
      
      private static const const_183:String = "0";
      
      private static const const_1479:String = "$";
      
      private static const const_1431:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1481:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      ...
      protected var var_1349:Dictionary;
      
      protected var var_1084:Dictionary;
      
      protected var var_1616:Dictionary;
      
      protected var var_2156:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1350,this.var_1349);
         this.var_1084 = new Dictionary();
         this.var_1616 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1084,this.var_1616);
         this.var_2156 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1486,const_50);
         return param1.replace(const_1481,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1349)
            {
               delete this.var_1349[_loc1_];
            }
            for(_loc1_ in this.var_1084)
            {
               delete this.var_1084[_loc1_];
            }
            for(_loc1_ in this.var_1616)
            {
               delete this.var_1616[_loc1_];
            }
            this.var_2156.dispose();
            this.var_2156 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1478)
         {
            _loc8_ = param1.child(const_1051);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1053).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1052);
         ...
         if(param1.localName() == const_1052)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         name = unescape(String(this.parseAttribute(xml,const_452,variables,"")));
         style = uint(this.parseAttribute(xml,const_1482,variables,style));
         params = uint(this.parseAttribute(xml,const_663,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1489,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_183));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_183));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_183));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_183));
         visible = this.parseAttribute(xml,const_1487,variables,visible.toString()) == const_662;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_663).length() > 0)
         {
            list = xml.child(const_663).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_452,variables,"") as String;
               if(this.var_1084[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_452)) + "\"!");
               }
               params |= this.var_1084[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1488,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1431);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1051)[0]),tags) as WindowController;
         ...
         window.limits.minHeight = int(this.parseAttribute(xml,const_1491,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1485,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_662;
         blend = Number(this.parseAttribute(xml,const_1295,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1483,variables,window.clipping.toString()) == const_662;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1484,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1053).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_211)
                     {
                        window.y = rect.y;
                     }
                  }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1349[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1110) == -1)
                  {
