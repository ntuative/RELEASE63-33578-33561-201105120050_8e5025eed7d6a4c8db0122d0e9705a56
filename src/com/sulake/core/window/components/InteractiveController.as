   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public static function readInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : void
      {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_739:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_459)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_739,param1.toolTipCaption,PropertyStruct.const_52,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1842);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1166)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_918,param1.toolTipDelay,PropertyStruct.const_283,true));
         }
         else
         {
