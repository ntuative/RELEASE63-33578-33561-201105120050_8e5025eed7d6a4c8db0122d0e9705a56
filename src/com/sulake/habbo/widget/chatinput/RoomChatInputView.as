package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private var var_1846:IWindow;
      
      private var _button:IWindow;
      
      private var var_1845:IWindow;
      
      private var var_1469:IWindow;
      ...
      private const const_2181:int = 250;
      
      private const const_2182:int = 0;
      
      private const const_2183:String = "${widgets.chatinput.say}";
      
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1188 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2528 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2527 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         var _loc2_:int = this._widget.config.getKey("friendbar.enabled") == "RoomWidgetInfostandExtraParamEnum" ? 55 : 5;
         ...
         this.var_1846 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_1845 = this._window.findChildByName("send_button_text");
         this.var_1469 = this._window.findChildByName("block_text");
         this.var_1845.caption = this.const_2183;
         this.var_25.setParamFlag(HabboWindowParam.const_41,true);
         this.var_25.addEventListener(WindowMouseEvent.const_45,this.windowMouseEventProcessor);
         this.var_25.addEventListener(WindowKeyboardEvent.const_214,this.windowKeyEventProcessor);
         this.var_25.addEventListener(WindowKeyboardEvent.const_339,this.keyUpHandler);
         ...
         this._window.addEventListener(WindowEvent.const_525,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_1846.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - this.const_2181 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),this.const_2182);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_25 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1188 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_25.text = "";
                  this.var_645 = "";
               }
      ...
      private function setButtonPressedState(param1:Boolean) : void
      {
         if(this._button)
         {
            this._button.setStateFlag(WindowState.const_90,param1);
         }
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_645.length + 1)
            {
               if(this._widget.allowPaste)
               {
                  this._widget.method_9();
               }
               else
               {
                  _loc2_.text = "";
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_646);
