package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private static const const_106:String = "floor";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1033 = this.parseElements(_loc2_.floors.pattern);
         this.var_1271 = this.parseElements(_loc2_.walls.pattern);
         this.var_1272 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_1033)
                  {
                     _loc11_ = this.var_1033[_loc10_];
                     if(this.var_680.indexOf(_loc10_) == -1)
                     {
                        this.var_680.push(_loc10_);
                        this.var_1274.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1271[_loc8_] != null)
                  {
                     this.var_832.push(_loc8_);
                     this.var_1273.push(_loc3_);
                  }
                  else
                  {
                  ...
                  break;
               case "landscape":
                  if(this.var_1272[_loc8_] != null)
                  {
                     this.var_833.push(_loc8_);
         ...
         this.changePattern(const_106,0);
         this.changePattern(const_229,0);
         this.changePattern(TYPE_LANDSCAPE,0);
         this.updateConfiguration();
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1561,this.var_1560,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1273[this.var_467];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_pattern_prev":
               this.changePattern(const_106,-1);
               break;
            case "ctlg_floor_pattern_next":
               this.changePattern(const_106,1);
               break;
            case "ctlg_floor_color_prev":
               this.changeColor(const_106,-1);
               break;
            case "ctlg_floor_color_next":
               this.changeColor(const_106,1);
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1274[this.var_464];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this._landscapeOffers[this.var_465];
               if(_loc3_ != null)
               {
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_680[this.var_464];
         var _loc3_:Array = this.var_1033[_loc2_];
         if(_loc3_ != null && this.var_463 >= 0)
         {
            _loc11_ = _loc3_[this.var_463];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1274[this.var_464];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_832[this.var_467];
         var _loc6_:Array = this.var_1271[_loc5_];
         if(_loc6_ != null && this.var_466 >= 0)
         {
            _loc13_ = _loc6_[this.var_466];
            if(_loc13_ != null)
            {
               this.var_1561 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1273[this.var_467];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_833[this.var_465];
         var _loc9_:Array = this.var_1272[_loc8_];
         if(_loc9_ != null && this.var_462 >= 0)
         {
            _loc15_ = _loc9_[this.var_462];
            if(_loc15_ != null)
            {
               this.var_1560 = _loc15_;
            }
         }
         var _loc10_:Offer = this._landscapeOffers[this.var_465];
         if(_loc10_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_106:
               ...
               if(this.var_464 < 0)
               {
                  this.var_464 = this.var_680.length - 1;
               }
               if(this.var_464 >= this.var_680.length)
               {
                  this.var_464 = 0;
               }
               this.var_463 = 0;
               this.var_1034 = 0;
               _loc5_ = this.var_680[this.var_464];
               _loc6_ = this.var_1033[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_1034 = _loc6_.length;
               }
            ...
            case const_229:
               ...
               if(this.var_467 < 0)
               {
                  this.var_467 = this.var_832.length - 1;
               }
               if(this.var_467 == this.var_832.length)
               {
                  this.var_467 = 0;
               }
               this.var_466 = 0;
               this.var_1032 = 0;
               _loc7_ = this.var_832[this.var_467];
               _loc8_ = this.var_1271[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_1032 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_465 < 0)
               {
                  this.var_465 = this.var_833.length - 1;
               }
               if(this.var_465 >= this.var_833.length)
               {
                  this.var_465 = 0;
               }
               this.var_462 = 0;
               this.var_1031 = 0;
               _loc9_ = this.var_833[this.var_465];
               _loc10_ = this.var_1272[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_1031 = _loc10_.length;
               }
