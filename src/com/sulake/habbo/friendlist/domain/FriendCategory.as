package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_423:int = 100;
      ...
      {
         var _loc4_:* = null;
         if(this.var_220.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         {
            _loc4_ = this.var_220[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               this.var_220.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean = false) : int
      {
         var _loc4_:* = null;
         var _loc3_:int = 0;
         for each(_loc4_ in this.var_220)
         {
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_220,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         return Math.ceil(this.var_220.length / const_423);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_917 * const_423;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_917 + 1) * const_423,this.var_220.length);
      }
