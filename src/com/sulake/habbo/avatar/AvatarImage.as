package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_566:IAvatarDataContainer;
      ...
      private var var_2422:String = null;
      
      private var var_2423:String = null;
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_1077)
         {
            ...
            if(this.var_747)
            {
               for each(_loc2_ in this.var_747)
               {
                  _loc2_.dispose();
               }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_249.length == 1 && this.var_90 == this.var_1777)
         {
            return this.var_90 + this.var_510 + this.var_614 % 4;
         }
         if(this.var_249.length == 2)
         {
            for each(_loc1_ in this.var_249)
            {
               ...
               {
                  return this.var_90 + this.var_510 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_614 % 11;
                  return this.var_90 + "_" + this.var_1777 + this.var_510 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2421 || param2 != this.var_2422 || param1 != this.var_2423)
         {
            this.var_2421 = param3;
            this.var_2422 = param2;
            this.var_2423 = param1;
            this.var_1779 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1341 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1341)
            {
               this.var_46.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_614);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_614);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_335.push(new ActiveActionData(param1,param2,this.var_614));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_937);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_510 = "";
         this.var_249 = this._structure.sortActions(this.var_335);
         if(this.var_249 == null)
         {
         ...
         {
            this.var_796 = this._structure.getCanvasOffsets(this.var_249,this._scale,this.var_90);
            for each(_loc4_ in this.var_249)
            {
               this.var_510 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_336)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1426 != _loc5_)
                  {
                     _loc2_ = true;
                  }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_249)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_938 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_300 || _loc1_.actionType == AvatarAction.const_288 || _loc1_.actionType == AvatarAction.const_385)
               {
                  this.var_938 = true;
               }
            }
