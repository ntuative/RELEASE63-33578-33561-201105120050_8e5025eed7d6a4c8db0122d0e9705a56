package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_55 == null)
         {
            this.var_55 = IWindowContainer(this._navigator.getXmlWindow(this.var_1080));
            this.var_55.visible = false;
            this.var_55.setParamFlag(HabboWindowParam.const_41,true);
         ...
         this.var_55.x = _loc2_.x + this.var_2226 + param1.width;
