   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_66,FigureData.FACE,_windowManager,_assetLibrary);
         }
         else
         {
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_66.controller.gender)
         {
            case FigureData.const_80:
               activateTab(this.const_650);
               inactivateTab(this.const_651);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_651);
               inactivateTab(this.const_650);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_650:
                  var_66.controller.gender = FigureData.const_80;
