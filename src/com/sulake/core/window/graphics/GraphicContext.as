package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1177:uint = 2;
      
      public static const const_807:uint = 4;
      
      public static const const_1750:uint = 8;
      
      public static const const_1699:uint = 16;
      
      public static const const_2077:uint = 64;
      
      public static const const_2018:uint = 128;
      
      public static const const_1096:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            case GraphicContext.const_824:
               ...
               break;
            case GraphicContext.const_1177:
            ...
            case GraphicContext.const_1750:
               ...
               break;
            case GraphicContext.const_1699:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_807:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1096:
               break;
         ...
         if(this.var_870)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2136,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2136,16777215);
                  }
                  var_337 += bitmap.width * bitmap.height * 4;
               }
