package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1331:Dictionary = createPropertySetterTable();
      ...
      protected var var_1083:Boolean = false;
      
      private var var_455:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_455,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_455 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_455,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      {
         return TextStyleManager.getStyle(this.var_455);
      }
      ...
      {
         return new Rectangle(this.var_876 * this.maxScrollH,this.var_569 * this.maxScrollV,width,height);
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         if(!this.var_568)
         {
            if(param2.type == WindowEvent.const_43)
            {
      ...
      protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         if(!_loc7_ && !param1)
         {
            _loc8_ = WindowEvent.allocate(WindowEvent.const_43,this,null);
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_455);
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_906,this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1294));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1267 ? new PropertyStruct(PropertyDefaults.const_707,this._autoSize,PropertyStruct.const_52,true,PropertyDefaults.const_1300) : PropertyDefaults.const_1700);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_283,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1238 ? new PropertyStruct(PropertyDefaults.const_1310,this._field.gridFitType,PropertyStruct.const_52,true,PropertyDefaults.const_1102) : PropertyDefaults.const_1785);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_709) ? new PropertyStruct(PropertyDefaults.const_430,this._field.textColor,PropertyStruct.const_134,true) : PropertyDefaults.const_1262);
         _loc1_.push(this.var_455 != TextStyleManager.const_209 ? new PropertyStruct(PropertyDefaults.const_437,this.var_455,PropertyStruct.const_52,true,PropertyDefaults.const_965) : PropertyDefaults.const_1223);
         _loc1_.push(this.var_41.left != PropertyDefaults.const_677 ? new PropertyStruct(PropertyDefaults.const_262,this.var_41.left,PropertyStruct.const_42,true) : PropertyDefaults.const_767);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_840 ? new PropertyStruct(PropertyDefaults.const_246,this.var_41.top,PropertyStruct.const_42,true) : PropertyDefaults.const_820);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_910 ? new PropertyStruct(PropertyDefaults.const_248,this.var_41.right,PropertyStruct.const_42,true) : PropertyDefaults.const_953);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_862 ? new PropertyStruct(PropertyDefaults.const_266,this.var_41.bottom,PropertyStruct.const_42,true) : PropertyDefaults.const_763);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1292 ? new PropertyStruct(PropertyDefaults.const_957,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1713);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_119,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_119,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_119,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
