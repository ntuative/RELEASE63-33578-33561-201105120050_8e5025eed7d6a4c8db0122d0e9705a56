package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1909 = int(this.var_175.getKey("latencytest.interval"));
         this.var_1907 = int(this.var_175.getKey("latencytest.report.index"));
         this.var_2603 = int(this.var_175.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1908 > this.var_1909)
         {
            this.testLatency();
         }
      }
      ...
      {
         this.var_1908 = getTimer();
         this.var_651.add(this.var_1496,this.var_1908);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1496));
         ++this.var_1496;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_651 == null || this.var_225 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = this.var_651.getValue(_loc2_.requestId);
         this.var_651.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         this.var_225.push(_loc4_);
         if(this.var_225.length == this.var_1907 && this.var_1907 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1906) > this.var_2603 || this.var_1906 == 0)
            {
               this.var_1906 = _loc9_;
