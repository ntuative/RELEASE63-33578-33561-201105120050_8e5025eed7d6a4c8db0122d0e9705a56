package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_221:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_947,this.onSoundMachinePlayEvent);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_976,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_80)
            {
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_947,this.onSoundMachinePlayEvent);
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_976,this.onSoundMachineStopEvent);
               this.var_80 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_448);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_221.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_448 = -1;
         this.var_650 = false;
         this.var_221.stop(HabboMusicPrioritiesEnum.const_124);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_221.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_221.playSong(param1,HabboMusicPrioritiesEnum.const_124,_loc3_,0,0,0))
         {
