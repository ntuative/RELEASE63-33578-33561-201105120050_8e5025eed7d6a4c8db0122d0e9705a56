package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class AnimationData
   {
      ...
      public static const const_2111:int = 0;
      ...
      private var var_1495:Array = null;
      ...
      {
         if(this.var_1495 != null && this.var_1495.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         if(_loc10_ > this.var_415)
         {
            this.var_415 = _loc10_;
         }
         return true;
      }
