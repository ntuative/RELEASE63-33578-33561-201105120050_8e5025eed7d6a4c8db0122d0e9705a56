package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      private var var_1931:WelcomeNotification;
      ...
      public function dispose() : void
      {
         if(this.var_177)
         {
            ...
            this.var_177.toolbar.events.removeEventListener(HabboToolbarEvent.const_37,this.onToolbarClicked);
            this.var_177 = null;
         }
      ...
      public function showWelcomeScreen(param1:WelcomeNotification) : void
      {
         ...
         _loc2_.caption = this.var_177.localization.getKey(param1.localizationKey);
         _loc2_.height = _loc2_.textHeight + 5;
         this.var_207.y = this.var_177.toolbar.getIconVerticalLocation(param1.targetIconId) - this._window.height / 2;
      ...
      {
         var _loc1_:XmlAsset = this.var_177.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_177.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
         ...
         _loc4_.content.setParamFlag(WindowParam.const_350,false);
         _loc4_.height -= 20;
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_382,this.var_1931.targetIconId);
