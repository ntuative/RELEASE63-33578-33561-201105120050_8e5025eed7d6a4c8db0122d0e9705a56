package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_679,RoomWidgetViralFurniMessage.const_751,RoomWidgetViralFurniMessage.const_172];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_679:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_598);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_751:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_593,RoomSessionViralFurniStatusEvent.const_473];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_593:
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_473:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_814);
               _loc3_.campaignID = _loc2_.campaignID;
               _loc3_.status = _loc2_.status;
               _loc3_.data = _loc2_.shareId;
               _loc3_.itemCategory = _loc2_.itemCategory;
