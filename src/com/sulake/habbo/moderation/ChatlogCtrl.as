package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_904:Array = [];
      
      private static var var_1717:int = 1000;
      
      private static var var_903:Array = [];
      
      private static var var_1715:int = 200;
      ...
      private var var_1714:IMessageComposer;
      ...
      {
         this.var_729 = IWindowContainer(this.var_33.getXmlWindow("chatlog_roomheader"));
         this.var_728 = IWindowContainer(this.var_33.getXmlWindow("chatlog_chatline"));
         this.var_494 = new Timer(1000,1);
         ...
         this.var_33.connection.send(this.var_1714);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_904.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_728.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_904.length < var_1717)
         {
            ...
            param1.width = this.var_728.width;
            param1.height = this.var_728.height;
            var_904.push(param1);
         }
         else
         {
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_903.pop() as IWindowContainer;
         }
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1716[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
      ...
      {
         if(param1.type != WindowEvent.const_43 || param2 != this._frame)
         {
            return;
         }
         this.var_494.reset();
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1386)
         {
