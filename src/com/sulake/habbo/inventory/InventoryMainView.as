package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2580:IWindowContainer;
      ...
      private const const_1005:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this._controller.inventoryViewOpened(this.var_791);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         else
         {
            ...
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_374 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_791);
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1881);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_374 == InventoryCategory.const_127)
            {
               this.toggleCategoryView(InventoryCategory.const_127);
            }
            else if(this.var_374 == InventoryCategory.const_70)
            {
               this.toggleCategoryView(InventoryCategory.const_70);
            }
            else if(this._controller != null)
            {
               this._controller.toggleInventoryPage(InventoryCategory.const_70);
            }
         }
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(!this.var_976)
         {
            ...
            _loc4_ = this.var_16.findChildByName("furni") as IWindowContainer;
            if(_loc4_)
            {
               _loc4_.addChild(_loc3_);
               _loc3_.x = _loc4_.width - _loc3_.width - const_988;
               _loc3_.y = const_988;
            }
            this.var_976 = _loc3_;
         }
         if(_loc1_ > 0)
         {
            ...
            this.var_976.findChildByName("count").caption = _loc1_.toString();
         }
         else
         {
